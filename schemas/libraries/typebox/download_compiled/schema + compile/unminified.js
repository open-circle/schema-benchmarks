...
function LegacyRetrievedResource(root, lexicalSchema, referenceBase, ref, schema) {
	...
	if (IsUndefined$1(targetBase) || IsEqual$1(targetBase, referenceBase)) return void 0;
	return {
		target: schema,
		base: targetBase,
		root: lexicalSchema
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.3.28/node_modules/typebox/build/schema/compile.mjs
var Validator = class {
	constructor(context, schema) {
