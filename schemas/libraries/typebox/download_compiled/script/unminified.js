...
function FromValue$1(value) {
	return IsTypeArray(value) ? FromTypedArray(value) : IsRegExp(value) ? FromRegExp$1(value) : IsMap(value) ? FromMap(value) : IsSet(value) ? FromSet(value) : IsArray$1(value) ? FromArray$4(value) : IsObject$1(value) ? FromObject$8(value) : value;
}
/**
...
const Factor = (input) => If(If(KeyOf(input), ([_0, input]) => If(Base$1(input), ([_1, input]) => If(IndexArray(input), ([_2, input]) => If(Extends$1(input), ([_3, input]) => If(With(input), ([_4, input]) => [[
	_0,
	_1,
	_2,
	_3,
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.3.34/node_modules/typebox/build/schema/parse.mjs
...
function ThrowParseError(context, schema, value) {
	EnableParseErrors();
