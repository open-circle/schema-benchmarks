...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/memory/metrics.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/memory/assign.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/guard/guard.mjs
var guard_exports = /* @__PURE__ */ __export({
	Entries: () => Entries$2,
	...
	Keys: () => Keys$1,
	StringGraphemeCount: () => StringGraphemeCount$1,
	Symbols: () => Symbols,
	Values: () => Values
});
...
function IsObjectNotArray$1(value) {
	return IsObject$2(value) && !IsArray$1(value);
}
/** Returns true if this value is an object */
function IsObject$2(value) {
	return IsEqual(typeof value, "object") && !IsNull$2(value);
}
...
function IsValueLike(value) {
	return IsBigInt$2(value) || IsBoolean$3(value) || IsNull$2(value) || IsNumber$3(value) || IsString$1(value) || IsUndefined$2(value);
}
/** Returns the number of Unicode Grapheme Clusters */
function StringGraphemeCount$1(value) {
	return Array.from(value).length;
}
function Every$1(value, offset, callback) {
	for (let index$1 = offset; index$1 < value.length; index$1++) if (!callback(value[index$1], index$1)) return false;
	return true;
}
function EveryAll(value, offset, callback) {
	let result = true;
	for (let index$1 = offset; index$1 < value.length; index$1++) if (!callback(value[index$1], index$1)) result = false;
	return result;
}
...
function EntriesRegExp(value) {
	return Keys$1(value).map((key) => [/* @__PURE__ */ new RegExp(`^${key}$`), value[key]]);
}
...
function DeepEqualObject(left, right) {
	...
	return IsEqual(keys.length, Keys$1(right).length) && keys.every((key) => IsDeepEqual$1(left[key], right[key]));
}
function DeepEqualArray(left, right) {
	return IsArray$1(right) && IsEqual(left.length, right.length) && left.every((_, index$1) => IsDeepEqual$1(left[index$1], right[index$1]));
}
/** Tests values for deep equality */
function IsDeepEqual$1(left, right) {
	return IsArray$1(left) ? DeepEqualArray(left, right) : IsObject$2(left) ? DeepEqualObject(left, right) : IsEqual(left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/guard/emit.mjs
...
function IsObjectNotArray(value) {
	return And(IsObject$1(value), Not(IsArray$2(value)));
}
/** Returns true if this value is an object */
...
function HasPropertyKey(value, key) {
	return IsEqual(key, "\"__proto__\"") || IsEqual(key, "\"toString\"") || IsEqual(key, "\"constructor\"") ? `Object.prototype.hasOwnProperty.call(${value}, ${key})` : `${key} in ${value}`;
}
...
function Constant(value) {
	return IsString$1(value) ? JSON.stringify(value) : `${value}`;
}
...
function ConstDeclaration(identifier$1, expression) {
	return `const ${identifier$1} = ${expression}`;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/guard/globals.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/memory/clone.mjs
...
function FromArray$12(value) {
	return value.map((value$1) => FromValue$3(value$1));
}
...
function FromValue$3(value) {
	return value instanceof RegExp ? FromRegExp$1(value) : IsGuard$1(value) ? FromGuard(value) : IsArray$1(value) ? FromArray$12(value) : IsObject$2(value) ? FromObject$15(value) : FromUnknown(value);
}
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/settings/settings.mjs
const settings = {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/memory/create.mjs
...
function Create$1(hidden, enumerable, options = {}) {
	Metrics.create += 1;
	const settings$1 = Get$3();
	const withOptions = Merge(Merge(Merge({}, hidden, { enumerable: settings$1.enumerableKind }), enumerable), options);
	return settings$1.immutableTypes ? Object.freeze(withOptions) : withOptions;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/memory/discard.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/memory/update.mjs
/**
...
function Update$1(current, hidden, enumerable) {
	...
	for (const key of Object.keys(hidden)) Object.defineProperty(result, key, {
		configurable: true,
		writable: true,
		enumerable: settings$1.enumerableKind,
		value: hidden[key]
	});
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/schema.mjs
function IsKind(value, kind) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && IsEqual(value["~kind"], kind);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/_optional.mjs
/** Returns true if this value is a OptionalAddAction. */
function IsOptionalAddAction(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "type") && IsEqual(value["~kind"], "OptionalAddAction") && IsSchema(value.type);
}
/** Returns true if this value is a OptionalRemoveAction. */
function IsOptionalRemoveAction(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "type") && IsEqual(value["~kind"], "OptionalRemoveAction") && IsSchema(value.type);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/_readonly.mjs
/** Returns true if this value is a ReadonlyAddAction. */
function IsReadonlyAddAction(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "type") && IsEqual(value["~kind"], "ReadonlyAddAction") && IsSchema(value.type);
}
/** Returns true if this value is a ReadonlyRemoveAction. */
function IsReadonlyRemoveAction(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "type") && IsEqual(value["~kind"], "ReadonlyRemoveAction") && IsSchema(value.type);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/deferred.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/_immutable.mjs
...
function IsImmutable(value) {
	return IsSchema(value) && HasPropertyKey$1(value, "~immutable");
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/_optional.mjs
...
function IsOptional(value) {
	return IsSchema(value) && HasPropertyKey$1(value, "~optional");
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/_readonly.mjs
...
function IsReadonly(value) {
	return IsSchema(value) && HasPropertyKey$1(value, "~readonly");
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/array.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/async-iterator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/base.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/constructor.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/function.mjs
/** Creates a Function type. */
function Function$1(parameters, returnType, options = {}) {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/ref.mjs
/** Creates a Ref type. */
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/generic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/never.mjs
const NeverPattern = "(?!)";
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/call/resolve-target.mjs
...
function FromType$18(context, name, target, arguments_) {
	return IsGeneric(target) ? FromGeneric(name, target.parameters, target.expression) : IsRef(target) ? FromRef$9(context, target.$ref, arguments_) : FromNotGeneric();
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/arguments/arguments.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/unknown.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/infer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/any.mjs
/** Creates a Any type. */
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/enum/typescript-enum-to-enum-values.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/enum.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/intersect.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/unreachable/unreachable.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/environment/can-evaluate.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/hashing/hash.mjs
...
function FromValue$2(value) {
	return IsTypeArray(value) ? FromTypeArray(value) : IsDate$1(value) ? FromDate(value) : IsRegExp(value) ? FromRegExp(value) : IsBoolean$1(value) ? FromBoolean$8(value.valueOf()) : IsString$2(value) ? FromString$8(value.valueOf()) : IsNumber$1(value) ? FromNumber$8(value.valueOf()) : IsIEEE754(value) ? FromNumber$8(value) : IsArray$1(value) ? FromArray$11(value) : IsBoolean$3(value) ? FromBoolean$8(value) : IsBigInt$2(value) ? FromBigInt$8(value) : IsConstructor$2(value) ? FromConstructor$1(value) : IsNull$2(value) ? FromNull$8(value) : IsObject$2(value) ? FromObject$14(value) : IsString$1(value) ? FromString$8(value) : IsSymbol$2(value) ? FromSymbol$1(value) : IsUndefined$2(value) ? FromUndefined$8(value) : IsFunction$2(value) ? FromFunction$1(value) : Unreachable();
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/locale/en_US.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/system/locale/_config.mjs
let locale = en_US;
/** Gets the locale */
function Get() {
	return locale;
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/_codec.mjs
...
function IsCodec(value) {
	return IsSchema(value) && HasPropertyKey$1(value, "~codec") && IsObject$2(value["~codec"]) && HasPropertyKey$1(value["~codec"], "encode") && HasPropertyKey$1(value["~codec"], "decode");
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/bigint.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/boolean.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/integer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/iterator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/literal.mjs
...
function LiteralTypeName(value) {
	return IsBigInt$2(value) ? "bigint" : IsBoolean$3(value) ? "boolean" : IsNumber$3(value) ? "number" : IsString$1(value) ? "string" : (() => {
...
function IsLiteralValue(value) {
	return IsBigInt$2(value) || IsBoolean$3(value) || IsNumber$3(value) || IsString$1(value);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/null.mjs
/** Creates a Null type. */
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/number.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/symbol.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/properties.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/promise.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/string.mjs
const StringPattern = ".*";
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/record-create.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/record.mjs
...
function RecordKey(type) {
	...
	return IsEqual(pattern, IntegerKey) ? Integer() : IsEqual(pattern, NumberKey) ? Number$1() : String$1();
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/rest.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/tuple.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/undefined.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/union.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/void.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/mapping.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/internal/result.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/internal/take.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/internal/char.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/internal/trim.mjs
const LineComment = "//";
const OpenComment = "/*";
const CloseComment = "*/";
function DiscardMultilineComment(input) {
	const index$1 = input.indexOf(CloseComment);
	return IsEqual(index$1, -1) ? "" : input.slice(index$1 + 2);
}
function DiscardLineComment(input) {
	const index$1 = input.indexOf(NewLine);
	return IsEqual(index$1, -1) ? "" : input.slice(index$1);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/integer.mjs
const AllowedDigits$1 = [...Digit, UnderScore];

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/const.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/ident.mjs
const Initial = [
	...Alpha,
	UnderScore,
	DollarSign
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/number.mjs
const AllowedDigits = [...Digit, UnderScore];

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/until.mjs
function IsEnd(end, input) {
	const [left, ...right] = end;
	return IsString$1(left) ? input.startsWith(left) ? true : IsEnd(right, input) : false;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/token/until_1.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/script/parser.mjs
const If = (result, left, right = () => []) => result.length === 2 ? left(result) : right();
const PatternBigInt = (input) => If(Const("-?(?:0|[1-9][0-9]*)n", input), ([_0, input$1]) => [PatternBigIntMapping(_0), input$1]);
const PatternString = (input) => If(Const(".*", input), ([_0, input$1]) => [PatternStringMapping(_0), input$1]);
const PatternNumber = (input) => If(Const("-?(?:0|[1-9][0-9]*)(?:.[0-9]+)?", input), ([_0, input$1]) => [PatternNumberMapping(_0), input$1]);
const PatternInteger = (input) => If(Const("-?(?:0|[1-9][0-9]*)", input), ([_0, input$1]) => [PatternIntegerMapping(_0), input$1]);
const PatternNever = (input) => If(Const("(?!)", input), ([_0, input$1]) => [PatternNeverMapping(_0), input$1]);
const PatternText = (input) => If(Until_1([
	...
	"$",
	"|"
], input), ([_0, input$1]) => [PatternTextMapping(_0), input$1]);
const PatternBase = (input) => If(If(PatternBigInt(input), ([_0, input$1]) => [_0, input$1], () => If(PatternString(input), ([_0, input$1]) => [_0, input$1], () => If(PatternNumber(input), ([_0, input$1]) => [_0, input$1], () => If(PatternInteger(input), ([_0, input$1]) => [_0, input$1], () => If(PatternNever(input), ([_0, input$1]) => [_0, input$1], () => If(PatternGroup(input), ([_0, input$1]) => [_0, input$1], () => If(PatternText(input), ([_0, input$1]) => [_0, input$1], () => []))))))), ([_0, input$1]) => [PatternBaseMapping(_0), input$1]);
const PatternGroup = (input) => If(If(Const("(", input), ([_0, input$1]) => If(PatternBody(input$1), ([_1, input$2]) => If(Const(")", input$2), ([_2, input$3]) => [[
	_0,
	_1,
	_2
], input$3]))), ([_0, input$1]) => [PatternGroupMapping(_0), input$1]);
const PatternUnion = (input) => If(If(If(PatternTerm(input), ([_0, input$1]) => If(Const("|", input$1), ([_1, input$2]) => If(PatternUnion(input$2), ([_2, input$3]) => [[
	_0,
	_1,
	_2
], input$3]))), ([_0, input$1]) => [_0, input$1], () => If(If(PatternTerm(input), ([_0, input$1]) => [[_0], input$1]), ([_0, input$1]) => [_0, input$1], () => If([[], input], ([_0, input$1]) => [_0, input$1], () => []))), ([_0, input$1]) => [PatternUnionMapping(_0), input$1]);
const PatternTerm = (input) => If(If(PatternBase(input), ([_0, input$1]) => If(PatternBody(input$1), ([_1, input$2]) => [[_0, _1], input$2])), ([_0, input$1]) => [PatternTermMapping(_0), input$1]);
const PatternBody = (input) => If(If(PatternUnion(input), ([_0, input$1]) => [_0, input$1], () => If(PatternTerm(input), ([_0, input$1]) => [_0, input$1], () => [])), ([_0, input$1]) => [PatternBodyMapping(_0), input$1]);
const Pattern = (input) => If(If(Const("^", input), ([_0, input$1]) => If(PatternBody(input$1), ([_1, input$2]) => If(Const("$", input$2), ([_2, input$3]) => [[
	_0,
	_1,
	_2
], input$3]))), ([_0, input$1]) => [PatternMapping(_0), input$1]);

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/template-literal.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/result.mjs
function ExtendsUnion$1(inferred) {
	return Create$1({ ["~kind"]: "ExtendsUnion" }, { inferred });
}
function IsExtendsUnion(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "inferred") && IsEqual(value["~kind"], "ExtendsUnion") && IsObject$2(value.inferred);
}
function ExtendsTrue(inferred) {
	return Create$1({ ["~kind"]: "ExtendsTrue" }, { inferred });
}
function IsExtendsTrue(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "inferred") && IsEqual(value["~kind"], "ExtendsTrue") && IsObject$2(value.inferred);
}
function ExtendsFalse() {
	return Create$1({ ["~kind"]: "ExtendsFalse" }, {});
}
function IsExtendsFalse(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && IsEqual(value["~kind"], "ExtendsFalse");
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/patterns/pattern.mjs
/** Parses a Pattern into a sequence of TemplateLiteral types */
function ParsePatternIntoTypes(pattern) {
	const parsed = Pattern(pattern);
	return IsEqual(parsed.length, 2) ? parsed[0] : Unreachable();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/template-literal/finite.mjs
function FromLiteral$5(value) {
	return true;
}
function FromTypesReduce(types) {
	const [left, ...right] = types;
	return IsSchema(left) ? FromType$17(left) ? FromTypesReduce(right) : false : true;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/template-literal/decode.mjs
function FromLiteralPush(variants, value, result = []) {
	const [left, ...right] = variants;
	return IsString$1(left) ? FromLiteralPush(right, value, [...result, `${left}${value}`]) : result;
}
...
function FromUnion$13(variants, types, result = []) {
	const [left, ...right] = types;
	return IsSchema(left) ? FromUnion$13(variants, right, [...result, ...FromType$16(variants, left)]) : result;
}
...
function DecodeFromSpan(variants, types) {
	const [left, ...right] = types;
	return IsSchema(left) ? DecodeFromSpan(FromType$16(variants, left), right) : variants;
}
...
function TemplateLiteralDecode(pattern) {
	...
	return TemplateLiteralFinite(types) ? DecodeTypes(types) : String$1();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/enum/enum-to-union.mjs
function FromEnumValue(value) {
	return IsString$1(value) || IsNumber$3(value) ? Literal(value) : IsNull$2(value) ? Null() : Never();
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/extends-right.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/any.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/array.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/async-iterator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/bigint.mjs
function ExtendsBigInt(inferred, left, right) {
	return IsBigInt(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/boolean.mjs
function ExtendsBoolean(inferred, left, right) {
	return IsBoolean(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/parameters.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/return-type.mjs
function ExtendsReturnType(inferred, left, right) {
	return IsVoid(right) ? ExtendsTrue(inferred) : ExtendsLeft(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/constructor.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/enum.mjs
function ExtendsEnum(inferred, left, right) {
	return ExtendsLeft(inferred, EnumToUnion(left), right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/function.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/integer.mjs
function ExtendsInteger(inferred, left, right) {
	return IsInteger(right) ? ExtendsTrue(inferred) : IsNumber(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/compare.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/flatten.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/tuple/to-object.mjs
function TupleElementsToProperties(types) {
	return types.reduceRight((result, right, index$1) => {
		return {
			[index$1]: right,
			...result
		};
...
function TupleToObject(type) {
	return Object$1(TupleElementsToProperties(type.items));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/composite.mjs
...
function Composite(left, right) {
	return Object$1(CompositeProperties(GetProperties(left), GetProperties(right)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/narrow.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/distribute.mjs
...
function DistributeOperation(left, right) {
	...
	return isObjectLeft && IsObjectRight ? Composite(EvaluateType(normalLeft), normalRight) : isObjectLeft && !IsObjectRight ? EvaluateType(normalLeft) : !isObjectLeft && IsObjectRight ? normalRight : Narrow(EvaluateType(normalLeft), normalRight);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/evaluate.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/broaden.mjs
...
function IsBroadestType(type, types) {
	const result = types.some((left) => {
		const result$1 = Compare(type, left);
		return IsEqual(result$1, ResultLeftInside) || IsEqual(result$1, ResultEqual);
	});
...
function BroadenTypes(types, result = []) {
	const [left, ...right] = types;
	return IsSchema(left) ? IsObject(left) ? BroadenTypes(right, [...result, left]) : BroadenTypes(right, BroadenType(left, result)) : result;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/evaluate/instantiate.mjs
function EvaluateImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(EvaluateType(instantiatedType), {}, options);
}
function EvaluateInstantiate(context, state$1, type, options) {
	return EvaluateImmediate(context, state$1, type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/intersect.mjs
function ExtendsIntersect(inferred, left, right) {
	return ExtendsLeft(inferred, EvaluateIntersect(left), right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/iterator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/literal.mjs
...
function ExtendsLiteral(inferred, left, right) {
	return IsBigInt$2(left.const) ? ExtendsLiteralBigInt(inferred, left.const, right) : IsBoolean$3(left.const) ? ExtendsLiteralBoolean(inferred, left.const, right) : IsNumber$3(left.const) ? ExtendsLiteralNumber(inferred, left.const, right) : IsString$1(left.const) ? ExtendsLiteralString(inferred, left.const, right) : Unreachable();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/never.mjs
function ExtendsNever(inferred, left, right) {
	return IsInfer(right) ? ExtendsRight(inferred, left, right) : ExtendsTrue(inferred);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/null.mjs
function ExtendsNull(inferred, left, right) {
	return IsNull(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/number.mjs
function ExtendsNumber(inferred, left, right) {
	return IsNumber(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/object.mjs
...
function ExtendsObject(inferred, left, right) {
	return IsObject(right) ? ExtendsObjectToObject(inferred, left, right.properties) : ExtendsRight(inferred, Object$1(left), right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/promise.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/string.mjs
function ExtendsString(inferred, left, right) {
	return IsString(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/symbol.mjs
function ExtendsSymbol(inferred, left, right) {
	return IsSymbol(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/template-literal.mjs
function ExtendsTemplateLiteral(inferred, left, right) {
	return ExtendsLeft(inferred, TemplateLiteralDecode(left), right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/inference.mjs
...
function IsInferable(value) {
	return IsObject$2(value) && HasPropertyKey$1(value, "~kind") && HasPropertyKey$1(value, "name") && HasPropertyKey$1(value, "type") && IsEqual(value["~kind"], "Inferrable") && IsString$1(value.name) && IsObject$2(value.type);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/tuple.mjs
...
function ElementsRight(inferred, reversed, leftRest, rightRest) {
	const [head, ...tail] = rightRest;
	return IsSchema(head) ? ElementsLeft(inferred, reversed, leftRest, head, tail) : IsEqual(leftRest.length, 0) ? ExtendsTrue(inferred) : ExtendsFalse();
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/undefined.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/union.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/unknown.mjs
function ExtendsUnknown(inferred, left, right) {
	return IsInfer(right) ? ExtendsRight(inferred, left, right) : IsAny(right) ? ExtendsTrue(inferred) : IsUnknown(right) ? ExtendsTrue(inferred) : ExtendsFalse();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/void.mjs
function ExtendsVoid(inferred, left, right) {
	return IsVoid(right) ? ExtendsTrue(inferred) : ExtendsRight(inferred, left, right);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/extends-left.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/interface.mjs
...
function IsInterfaceDeferred(value) {
	return IsSchema(value) && HasPropertyKey$1(value, "action") && IsEqual(value.action, "Interface");
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/cyclic/check.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/cyclic/candidates.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/cyclic/dependencies.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/cyclic/extends.mjs
...
function FromType$13(type) {
	return IsRef(type) ? FromRef$6(type.$ref) : IsArray(type) ? Array$1(FromType$13(type.items), ArrayOptions(type)) : IsAsyncIterator(type) ? AsyncIterator(FromType$13(type.iteratorItems)) : IsConstructor(type) ? Constructor(FromTypes(type.parameters), FromType$13(type.instanceType)) : IsFunction(type) ? Function$1(FromTypes(type.parameters), FromType$13(type.returnType)) : IsIntersect(type) ? Intersect(FromTypes(type.allOf)) : IsIterator(type) ? Iterator(FromType$13(type.iteratorItems)) : IsObject(type) ? Object$1(FromProperties$1(type.properties)) : IsPromise(type) ? Promise$1(FromType$13(type.item)) : IsRecord(type) ? Record(RecordKey(type), FromType$13(RecordValue(type))) : IsUnion(type) ? Union(FromTypes(type.anyOf)) : IsTuple(type) ? Tuple(FromTypes(type.items)) : type;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/cyclic/instantiate.mjs
function CyclicInterface(context, heritage, properties) {
	...
	return EvaluateIntersect([...instantiatedHeritage, Object$1(instantiatedProperties)]);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/cyclic/target.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/extends/extends.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/call/resolve-arguments.mjs
...
function BindArgument(context, state$1, name, extends_, type) {
	const instantiatedArgument = InstantiateType(context, state$1, type);
	AssertArgumentExtends(name, instantiatedArgument, extends_);
	return Assign(context, { [name]: instantiatedArgument });
}
function BindArguments(context, state$1, parameterLeft, parameterRight, arguments_) {
	const instantiatedExtends = InstantiateType(context, state$1, parameterLeft.extends);
	const instantiatedEquals = InstantiateType(context, state$1, parameterLeft.equals);
	const [left, ...right] = arguments_;
	return IsSchema(left) ? BindParameters(BindArgument(context, state$1, parameterLeft["name"], instantiatedExtends, left), state$1, parameterRight, right) : BindParameters(BindArgument(context, state$1, parameterLeft["name"], instantiatedExtends, instantiatedEquals), state$1, parameterRight, []);
}
function BindParameters(context, state$1, parameters, arguments_) {
	const [left, ...right] = parameters;
	return IsSchema(left) ? BindArguments(context, state$1, left, right, arguments_) : context;
}
function ResolveArgumentsContext(context, state$1, parameters, arguments_) {
	return BindParameters(context, state$1, parameters, arguments_);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/call/instantiate.mjs
function Peek(callstack) {
	return IsGreaterThan$1(callstack.length, 0) ? callstack[0] : "";
}
function DeferredCall(context, state$1, target, arguments_) {
	return CallConstruct(target, InstantiateTypes(context, state$1, arguments_));
}
function TailCall(context, state$1, name, arguments_) {
	return DeferredCall(context, state$1, Ref(name), arguments_);
}
function HeadCall(context, state$1, name, parameters, expression, arguments_) {
	return InstantiateType(context, state$1, InstantiateType(ResolveArgumentsContext(context, state$1, parameters, InstantiateTypes(context, state$1, arguments_)), { callstack: [...state$1.callstack, name] }, expression));
}
function CallInstantiate(context, state$1, target, arguments_) {
	const [name, type] = ResolveTarget(context, target, arguments_);
	return IsGeneric(type) ? IsEqual(Peek(state$1.callstack), name) ? TailCall(context, state$1, name, arguments_) : HeadCall(context, state$1, name, type.parameters, type.expression, arguments_) : DeferredCall(context, state$1, target, arguments_);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/types/call.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/awaited/instantiate.mjs
function AwaitedAction(type) {
	return IsPromise(type) ? AwaitedAction(type.item) : type;
}
function AwaitedImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(AwaitedAction(instantiatedType), {}, options);
}
function AwaitedInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? AwaitedImmediate(context, state$1, type, options) : AwaitedDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/intrinsics/mapping.mjs
function ApplyMapping(mapping, value) {
	return mapping(value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/intrinsics/from-literal.mjs
function FromLiteral$3(mapping, value) {
	return IsString$1(value) ? Literal(ApplyMapping(mapping, value)) : Literal(value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/intrinsics/from-template-literal.mjs
function FromTemplateLiteral$4(mapping, pattern) {
	return FromType$12(mapping, TemplateLiteralDecode(pattern));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/intrinsics/from-union.mjs
function FromUnion$12(mapping, types) {
	return Union(types.map((type) => FromType$12(mapping, type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/intrinsics/from-type.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/capitalize.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/lowercase.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/uncapitalize.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/uppercase.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/intrinsics/instantiate.mjs
...
function CapitalizeImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$12(CapitalizeMapping, instantiatedType), {}, options);
}
function CapitalizeInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? CapitalizeImmediate(context, state$1, type, options) : CapitalizeDeferred(type, options);
}
function LowercaseImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$12(LowercaseMapping, instantiatedType), {}, options);
}
function LowercaseInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? LowercaseImmediate(context, state$1, type, options) : LowercaseDeferred(type, options);
}
function UncapitalizeImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$12(UncapitalizeMapping, instantiatedType), {}, options);
}
function UncapitalizeInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? UncapitalizeImmediate(context, state$1, type, options) : UncapitalizeDeferred(type, options);
}
function UppercaseImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$12(UppercaseMapping, instantiatedType), {}, options);
}
function UppercaseInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? UppercaseImmediate(context, state$1, type, options) : UppercaseDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/conditional.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/conditional/instantiate.mjs
function ConditionalImmediate(context, state$1, left, right, true_, false_, options) {
	const extendsResult = Extends(context, InstantiateType(context, state$1, left), InstantiateType(context, state$1, right));
	return Update$1(IsExtendsUnion(extendsResult) ? Union([InstantiateType(extendsResult.inferred, state$1, true_), InstantiateType(context, state$1, false_)]) : IsExtendsTrue(extendsResult) ? InstantiateType(extendsResult.inferred, state$1, true_) : InstantiateType(context, state$1, false_), {}, options);
}
function ConditionalInstantiate(context, state$1, left, right, true_, false_, options) {
	return CanInstantiate(context, [left, right]) ? ConditionalImmediate(context, state$1, left, right, true_, false_, options) : ConditionalDeferred(left, right, true_, false_, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/constructor-parameters.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/constructor-parameters/instantiate.mjs
function ConstructorParametersAction(type) {
	return IsConstructor(type) ? InstantiateType({}, { callstack: [] }, Tuple(type.parameters)) : Never();
}
function ConstructorParametersImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(ConstructorParametersAction(instantiatedType), {}, options);
}
function ConstructorParametersInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? ConstructorParametersImmediate(context, state$1, type, options) : ConstructorParametersDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/exclude.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/exclude/instantiate.mjs
...
function ExcludeImmediate(context, state$1, left, right, options) {
	const instantiatedLeft = InstantiateType(context, state$1, left);
	const instantiatedRight = InstantiateType(context, state$1, right);
	return Update$1(ExcludeAction(instantiatedLeft, instantiatedRight), {}, options);
}
function ExcludeInstantiate(context, state$1, left, right, options) {
	return CanInstantiate(context, [left, right]) ? ExcludeImmediate(context, state$1, left, right, options) : ExcludeDeferred(left, right, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/extract.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/extract/instantiate.mjs
...
function ExtractImmediate(context, state$1, left, right, options) {
	const instantiatedLeft = InstantiateType(context, state$1, left);
	const instantiatedRight = InstantiateType(context, state$1, right);
	return Update$1(ExtractAction(instantiatedLeft, instantiatedRight), {}, options);
}
function ExtractInstantiate(context, state$1, left, right, options) {
	return CanInstantiate(context, [left, right]) ? ExtractImmediate(context, state$1, left, right, options) : ExtractDeferred(left, right, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/helpers/keys.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexed/from-array.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-cyclic.mjs
function FromCyclic$10(defs, ref) {
	return FromType$11(CyclicTarget(defs, ref));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-union.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-enum.mjs
function FromEnum$2(values) {
	return FromUnion$11(EnumValuesToVariants(values));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-intersect.mjs
function FromIntersect$10(types) {
	return FromType$11(EvaluateIntersect(types));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-literal.mjs
function FromLiteral$2(value) {
	return [`${value}`];
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-template-literal.mjs
function FromTemplateLiteral$3(pattern) {
	return FromType$11(TemplateLiteralDecode(pattern));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/from-type.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/to-indexable-keys.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexed/from-object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexed/array-indexer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexed/from-tuple.mjs
function IndexElementsWithIndexer(types, indexer) {
	return types.reduceRight((result, right, index$1) => {
		const check = Extends({}, Literal(index$1), indexer);
		return IsExtendsTrueLike(check) ? [right, ...result] : result;
	}, []);
}
function FromTupleWithIndexer(types, indexer) {
	return EvaluateUnion(IndexElementsWithIndexer(types, FormatArrayIndexer(indexer)));
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/indexed.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/from-cyclic.mjs
function FromCyclic$9(defs, ref) {
	return FromType$10(CyclicTarget(defs, ref));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/from-intersect.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/from-object.mjs
function FromObject$13(properties) {
	return properties;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/from-tuple.mjs
function FromTuple$9(types) {
	return FromType$10(TupleToObject(Tuple(types)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/from-union.mjs
...
function ReduceVariants(types, result) {
	const [left, ...right] = types;
	return IsSchema(left) ? ReduceVariants(right, CollapseUnionProperties(result, FromType$10(left))) : result;
}
function FromUnion$10(types) {
	const [left, ...right] = types;
	return IsSchema(left) ? ReduceVariants(right, FromType$10(left)) : Unreachable();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/from-type.mjs
function FromType$10(type) {
	return IsCyclic(type) ? FromCyclic$9(type.$defs, type.$ref) : IsIntersect(type) ? FromIntersect$9(type.allOf) : IsUnion(type) ? FromUnion$10(type.anyOf) : IsTuple(type) ? FromTuple$9(type.items) : IsObject(type) ? FromObject$13(type.properties) : {};
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/object/collapse.mjs
/**
...
function CollapseToObject(type) {
	return Object$1(FromType$10(type));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexed/instantiate.mjs
...
function IndexAction(type, indexer) {
	...
	return IsArray(normal) ? FromArray$10(normal.items, indexer) : IsObject(normal) ? FromObject$12(normal.properties, indexer) : IsTuple(normal) ? FromTuple$8(normal.items, indexer) : Never();
}
function IndexImmediate(context, state$1, type, indexer, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	const instantiatedIndexer = InstantiateType(context, state$1, indexer);
	return Update$1(IndexAction(instantiatedType, instantiatedIndexer), {}, options);
}
function IndexInstantiate(context, state$1, type, indexer, options) {
	return CanInstantiate(context, [type, indexer]) ? IndexImmediate(context, state$1, type, indexer, options) : IndexDeferred(type, indexer, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/instance-type.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/instance-type/instantiate.mjs
function InstanceTypeAction(type) {
	return IsConstructor(type) ? type.instanceType : Never();
}
function InstanceTypeImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(InstanceTypeAction(instantiatedType), {}, options);
}
function InstanceTypeInstantiate(context, state$1, type, options = {}) {
	return CanInstantiate(context, [type]) ? InstanceTypeImmediate(context, state$1, type, options) : InstanceTypeDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/interface/instantiate.mjs
function InterfaceImmediate(context, state$1, heritage, properties, options) {
	const instantiatedHeritage = InstantiateTypes(context, { callstack: [] }, heritage);
	const instantiatedProperties = InstantiateProperties(context, { callstack: [] }, properties);
	const evaluatedInterface = EvaluateIntersect([...instantiatedHeritage, Object$1(instantiatedProperties)]);
	return Update$1(evaluatedInterface, {}, options);
}
function InterfaceInstantiate(context, state$1, heritage, properties, options) {
	return CanInstantiate(context, heritage) ? InterfaceImmediate(context, state$1, heritage, properties, options) : InterfaceDeferred(heritage, properties, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/keyof.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/keyof/from-any.mjs
function FromAny() {
	return Union([
		Number$1(),
		String$1(),
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/keyof/from-array.mjs
function FromArray$9(_type) {
	return Number$1();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/keyof/from-object.mjs
...
function FromObject$11(properties) {
	return EvaluateUnion(FromPropertyKeys(Keys$1(properties)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/keyof/from-record.mjs
function FromRecord$6(type) {
	return RecordKey(type);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/keyof/from-tuple.mjs
function FromTuple$7(types) {
	return EvaluateUnion(types.map((_, index$1) => Literal(index$1)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/keyof/instantiate.mjs
...
function KeyOfImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(KeyOfAction(instantiatedType), {}, options);
}
function KeyOfInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? KeyOfImmediate(context, state$1, type, options) : KeyOfDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/mapped/mapped-keys.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/mapped.mjs
/** Creates a deferred Mapped action. */
function MappedDeferred(identifier$1, key, as, property, options = {}) {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/mapped/instantiate.mjs
function InstantiateKeyAs(context, state$1, identifier$1, key, as) {
	const instantiatedKeyAs = InstantiateType(Assign(context, { [identifier$1["name"]]: key }), state$1, as);
	return IsTemplateLiteral(instantiatedKeyAs) ? TemplateLiteralDecode(instantiatedKeyAs.pattern) : instantiatedKeyAs;
}
function InstantiateProperty(context, state$1, identifier$1, key, property) {
	return InstantiateType(Assign(context, { [identifier$1["name"]]: key }), state$1, property);
}
function MappedProperty(context, state$1, identifier$1, key, as, property) {
	const instantiatedProperty = InstantiateProperty(context, state$1, identifier$1, key, property);
	const instantiatedKeyAs = InstantiateKeyAs(context, state$1, identifier$1, key, as);
	return IsLiteralString(instantiatedKeyAs) || IsLiteralNumber(instantiatedKeyAs) ? { [instantiatedKeyAs.const]: instantiatedProperty } : {};
}
function MappedProperties(context, state$1, identifier$1, keys, as, type) {
	return keys.reduce((result, left) => {
		return {
			...result,
			...MappedProperty(context, state$1, identifier$1, left, as, type)
		};
	}, {});
}
function MappedAction(context, state$1, identifier$1, key, as, type) {
	return Object$1(MappedProperties(context, state$1, identifier$1, MappedKeys(key), as, type));
}
function MappedImmediate(context, state$1, identifier$1, key, as, property, options) {
	const instantiatedKey = InstantiateType(context, state$1, key);
	return Update$1(MappedAction(context, state$1, identifier$1, instantiatedKey, as, property), {}, options);
}
function MappedInstantiate(context, state$1, identifier$1, key, as, property, options) {
	return CanInstantiate(context, [key]) ? MappedImmediate(context, state$1, identifier$1, key, as, property, options) : MappedDeferred(identifier$1, key, as, property, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/module/instantiate.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/non-nullable.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/non-nullable/instantiate.mjs
function NonNullableAction(type) {
	return ExcludeInstantiate({}, { callstack: [] }, type, Union([Null(), Undefined()]), {});
}
function NonNullableImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(NonNullableAction(instantiatedType), {}, options);
}
function NonNullableInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? NonNullableImmediate(context, state$1, type, options) : NonNullableDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/indexable/to-indexable.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/omit.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/omit/instantiate.mjs
...
function OmitAction(type, indexer) {
	return Object$1(FromKeys$1(ToIndexable(type), ToIndexableKeys(indexer)));
}
function OmitImmediate(context, state$1, type, indexer, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	const instantiatedIndexer = InstantiateType(context, state$1, indexer);
	return Update$1(OmitAction(instantiatedType, instantiatedIndexer), {}, options);
}
function OmitInstantiate(context, state$1, type, indexer, options) {
	return CanInstantiate(context, [type, indexer]) ? OmitImmediate(context, state$1, type, indexer, options) : OmitDeferred(type, indexer, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/options.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/options/instantiate.mjs
function OptionsImmediate(context, state$1, type, options) {
	const instaniatedType = InstantiateType(context, state$1, type);
	return Update$1(instaniatedType, {}, options);
}
function OptionsInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? OptionsImmediate(context, state$1, type, options) : OptionsDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/parameters.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/parameters/instantiate.mjs
function ParametersAction(type) {
	return IsFunction(type) ? InstantiateType({}, { callstack: [] }, Tuple(type.parameters)) : Never();
}
function ParametersImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(ParametersAction(instantiatedType), {}, options);
}
function ParametersInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? ParametersImmediate(context, state$1, type, options) : ParametersDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/partial.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/partial/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/partial/from-intersect.mjs
function FromIntersect$8(types) {
	return EvaluateIntersect(types.map((type) => FromType$8(type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/partial/from-union.mjs
function FromUnion$8(types) {
	return Union(types.map((type) => FromType$8(type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/partial/from-object.mjs
function FromObject$10(properties) {
	return Object$1(Keys$1(properties).reduce((result, left) => {
		return {
			...result,
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/partial/from-type.mjs
function FromType$8(type) {
	return IsCyclic(type) ? FromCyclic$8(type.$defs, type.$ref) : IsIntersect(type) ? FromIntersect$8(type.allOf) : IsUnion(type) ? FromUnion$8(type.anyOf) : IsObject(type) ? FromObject$10(type.properties) : Object$1({});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/partial/instantiate.mjs
function PartialImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$8(instantiatedType), {}, options);
}
function PartialInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? PartialImmediate(context, state$1, type, options) : PartialDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/pick.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/pick/instantiate.mjs
...
function PickAction(type, indexer) {
	return Object$1(FromKeys(ToIndexable(type), ToIndexableKeys(indexer)));
}
function PickImmediate(context, state$1, type, indexer, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	const instantiatedIndexer = InstantiateType(context, state$1, indexer);
	return Update$1(PickAction(instantiatedType, instantiatedIndexer), {}, options);
}
function PickInstantiate(context, state$1, type, indexer, options) {
	return CanInstantiate(context, [type, indexer]) ? PickImmediate(context, state$1, type, indexer, options) : PickDeferred(type, indexer, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/readonly-type.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-array.mjs
function FromArray$8(type) {
	return Immutable(Array$1(type));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-intersect.mjs
function FromIntersect$7(types) {
	return EvaluateIntersect(types.map((type) => FromType$7(type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-tuple.mjs
function FromTuple$6(types) {
	return Immutable(Tuple(types));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-union.mjs
function FromUnion$7(types) {
	return Union(types.map((type) => FromType$7(type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/from-type.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/readonly-type/instantiate.mjs
function ReadonlyTypeImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$7(instantiatedType), {}, options);
}
function ReadonlyTypeInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? ReadonlyTypeImmediate(context, state$1, type, options) : ReadonlyTypeDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-any.mjs
function FromAnyKey(value) {
	return CreateRecord(StringKey, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-boolean.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-enum.mjs
function FromEnumKey(values, value) {
	return FromKey(EnumValuesToUnion(values), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-integer.mjs
function FromIntegerKey(key, value) {
	return CreateRecord(IntegerKey, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-intersect.mjs
function FromIntersectKey(types, value) {
	return FromKey(EvaluateIntersect(types), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-literal.mjs
function FromLiteralKey(key, value) {
	return IsString$1(key) || IsNumber$3(key) ? Object$1({ [key]: value }) : IsEqual(key, false) ? Object$1({ false: value }) : IsEqual(key, true) ? Object$1({ true: value }) : Object$1({});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-number.mjs
function FromNumberKey(key, value) {
	return CreateRecord(NumberKey, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-string.mjs
function FromStringKey(key, value) {
	return HasPropertyKey$1(key, "pattern") && (IsString$1(key.pattern) || key.pattern instanceof RegExp) ? CreateRecord(key.pattern.toString(), value) : CreateRecord(StringKey, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-template-literal.mjs
function FromTemplateKey(pattern, value) {
	return TemplateLiteralFinite(ParsePatternIntoTypes(pattern)) ? FromKey(TemplateLiteralDecode(pattern), value) : CreateRecord(pattern, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key-union.mjs
...
function CreateProperties(types, value) {
	return types.reduce((result, left) => {
		return IsLiteral(left) && (IsString$1(left.const) || IsNumber$3(left.const)) ? {
			...result,
			[left.const]: value
		} : result;
	}, {});
...
function CreateObject(types, value) {
	return Object$1(CreateProperties(types, value));
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/from-key.mjs
function FromKey(key, value) {
	return IsAny(key) ? FromAnyKey(value) : IsBoolean(key) ? FromBooleanKey(value) : IsEnum$1(key) ? FromEnumKey(key.enum, value) : IsInteger(key) ? FromIntegerKey(key, value) : IsIntersect(key) ? FromIntersectKey(key.allOf, value) : IsLiteral(key) ? FromLiteralKey(key.const, value) : IsNumber(key) ? FromNumberKey(key, value) : IsUnion(key) ? FromUnionKey(key.anyOf, value) : IsString(key) ? FromStringKey(key, value) : IsTemplateLiteral(key) ? FromTemplateKey(key.pattern, value) : Object$1({});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/record/instantiate.mjs
function RecordImmediate(context, state$1, key, value, options) {
	const instanstiatedKey = InstantiateType(context, state$1, key);
	const instantiatedValue = InstantiateType(context, state$1, value);
	return Update$1(FromKey(instanstiatedKey, instantiatedValue), {}, options);
}
function RecordInstantiate(context, state$1, key, value, options) {
	return CanInstantiate(context, [key]) ? RecordImmediate(context, state$1, key, value, options) : RecordDeferred(key, value, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/ref/instantiate.mjs
function RefInstantiate(context, state$1, ref) {
	return ref in context ? CyclicCheck([ref], context, context[ref]) ? Ref(ref) : InstantiateType(context, state$1, context[ref]) : Ref(ref);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/required/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/required/from-intersect.mjs
function FromIntersect$6(types) {
	return EvaluateIntersect(types.map((type) => FromType$6(type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/required/from-union.mjs
function FromUnion$6(types) {
	return Union(types.map((type) => FromType$6(type)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/required/from-object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/required/from-type.mjs
function FromType$6(type) {
	return IsCyclic(type) ? FromCyclic$6(type.$defs, type.$ref) : IsIntersect(type) ? FromIntersect$6(type.allOf) : IsUnion(type) ? FromUnion$6(type.anyOf) : IsObject(type) ? FromObject$8(type.properties) : Object$1({});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/required.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/required/instantiate.mjs
function RequiredImmediate(context, state$1, type, options) {
	const instaniatedType = InstantiateType(context, state$1, type);
	return Update$1(FromType$6(instaniatedType), {}, options);
}
function RequiredInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? RequiredImmediate(context, state$1, type, options) : RequiredDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/return-type.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/return-type/instantiate.mjs
function ReturnTypeAction(type) {
	return IsFunction(type) ? type.returnType : Never();
}
function ReturnTypeImmediate(context, state$1, type, options) {
	const instantiatedType = InstantiateType(context, state$1, type);
	return Update$1(ReturnTypeAction(instantiatedType), {}, options);
}
function ReturnTypeInstantiate(context, state$1, type, options) {
	return CanInstantiate(context, [type]) ? ReturnTypeImmediate(context, state$1, type, options) : ReturnTypeDeferred(type, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/template-literal/create.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/template-literal/encode.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/template-literal/instantiate.mjs
function TemplateLiteralImmediate(context, state$1, types, options) {
	const instaniatedTypes = InstantiateTypes(context, state$1, types);
	return Update$1(TemplateLiteralEncode(instaniatedTypes), {}, options);
}
function TemplateLiteralInstantiate(context, state$1, types, options) {
	return CanInstantiate(context, types) ? TemplateLiteralImmediate(context, state$1, types, options) : TemplateLiteralDeferred(types, options);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/rest/spread.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/engine/instantiate.mjs
...
function InstantiateProperties(context, state$1, properties) {
	return Keys$1(properties).reduce((result, key) => {
		return {
			...result,
			[key]: InstantiateType(context, state$1, properties[key])
		};
	}, {});
}
function InstantiateElements(context, state$1, types) {
	return RestSpread(InstantiateTypes(context, state$1, types));
}
function InstantiateTypes(context, state$1, types) {
	return types.map((type) => InstantiateType(context, state$1, type));
}
function InstantiateDeferred(context, state$1, action, parameters, options) {
	return IsEqual(action, "Awaited") ? AwaitedInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Capitalize") ? CapitalizeInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Conditional") ? ConditionalInstantiate(context, state$1, parameters[0], parameters[1], parameters[2], parameters[3], options) : IsEqual(action, "ConstructorParameters") ? ConstructorParametersInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Evaluate") ? EvaluateInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Exclude") ? ExcludeInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "Extract") ? ExtractInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "Index") ? IndexInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "InstanceType") ? InstanceTypeInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Interface") ? InterfaceInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "KeyOf") ? KeyOfInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Lowercase") ? LowercaseInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Mapped") ? MappedInstantiate(context, state$1, parameters[0], parameters[1], parameters[2], parameters[3], options) : IsEqual(action, "Module") ? ModuleInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "NonNullable") ? NonNullableInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Pick") ? PickInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "Options") ? OptionsInstantiate(context, state$1, parameters[0], parameters[1]) : IsEqual(action, "Parameters") ? ParametersInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Partial") ? PartialInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Omit") ? OmitInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "ReadonlyType") ? ReadonlyTypeInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Record") ? RecordInstantiate(context, state$1, parameters[0], parameters[1], options) : IsEqual(action, "Required") ? RequiredInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "ReturnType") ? ReturnTypeInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "TemplateLiteral") ? TemplateLiteralInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Uncapitalize") ? UncapitalizeInstantiate(context, state$1, parameters[0], options) : IsEqual(action, "Uppercase") ? UppercaseInstantiate(context, state$1, parameters[0], options) : Deferred(action, parameters, options);
}
function InstantiateType(context, state$1, input) {
	const cloned = IsBase(input) ? input.Clone() : input;
	const immutable = IsImmutable(cloned);
	const modifiers = ModifierActions(cloned, IsReadonly(cloned) ? "add" : "none", IsOptional(cloned) ? "add" : "none");
	const type = modifiers[0];
	const instantiated = IsRef(type) ? RefInstantiate(context, state$1, type.$ref) : IsArray(type) ? Array$1(InstantiateType(context, state$1, type.items), ArrayOptions(type)) : IsAsyncIterator(type) ? AsyncIterator(InstantiateType(context, state$1, type.iteratorItems), AsyncIteratorOptions(type)) : IsCall(type) ? CallInstantiate(context, state$1, type.target, type.arguments) : IsConstructor(type) ? Constructor(InstantiateTypes(context, state$1, type.parameters), InstantiateType(context, state$1, type.instanceType), ConstructorOptions(type)) : IsDeferred(type) ? InstantiateDeferred(context, state$1, type.action, type.parameters, type.options) : IsFunction(type) ? Function$1(InstantiateTypes(context, state$1, type.parameters), InstantiateType(context, state$1, type.returnType), FunctionOptions(type)) : IsIntersect(type) ? Intersect(InstantiateTypes(context, state$1, type.allOf), IntersectOptions(type)) : IsIterator(type) ? Iterator(InstantiateType(context, state$1, type.iteratorItems), IteratorOptions(type)) : IsObject(type) ? Object$1(InstantiateProperties(context, state$1, type.properties), ObjectOptions(type)) : IsPromise(type) ? Promise$1(InstantiateType(context, state$1, type.item), PromiseOptions(type)) : IsRecord(type) ? RecordFromPattern(RecordPattern(type), InstantiateType(context, state$1, RecordValue(type))) : IsRest(type) ? Rest(InstantiateType(context, state$1, type.items)) : IsTuple(type) ? Tuple(InstantiateElements(context, state$1, type.items), TupleOptions(type)) : IsUnion(type) ? Union(InstantiateTypes(context, state$1, type.anyOf), UnionOptions(type)) : type;
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/awaited.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/type/action/evaluate.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/_guard.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/_refine.mjs
/**
* Returns true if the schema contains an '~refine` keyword
* @specification None
*/
function IsRefine(value) {
	return HasPropertyKey$1(value, "~refine") && IsArray$1(value["~refine"]) && Every$1(value["~refine"], 0, (value$1) => IsObject$2(value$1) && HasPropertyKey$1(value$1, "refine") && HasPropertyKey$1(value$1, "message") && IsFunction$2(value$1.refine) && IsString$1(value$1.message));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/schema.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/additionalItems.mjs
/**
* Returns true if the schema contains a valid additionalItems property
* @specification Json Schema 7
*/
function IsAdditionalItems(schema) {
	return HasPropertyKey$1(schema, "additionalItems") && IsSchema$1(schema.additionalItems);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/additionalProperties.mjs
/**
* Returns true if the schema contains a valid additionalProperties property
* @specification Json Schema 7
*/
function IsAdditionalProperties(schema) {
	return HasPropertyKey$1(schema, "additionalProperties") && IsSchema$1(schema.additionalProperties);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/allOf.mjs
/**
* Returns true if the schema contains a valid allOf property
* @specification Json Schema 7
*/
function IsAllOf(schema) {
	return HasPropertyKey$1(schema, "allOf") && IsArray$1(schema.allOf) && schema.allOf.every((value) => IsSchema$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/anchor.mjs
/**
* Returns true if the schema contains a valid $anchor property
*/
function IsAnchor(schema) {
	return HasPropertyKey$1(schema, "$anchor") && IsString$1(schema.$anchor);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/anyOf.mjs
/**
* Returns true if the schema contains a valid anyOf property
* @specification Json Schema 7
*/
function IsAnyOf(schema) {
	return HasPropertyKey$1(schema, "anyOf") && IsArray$1(schema.anyOf) && schema.anyOf.every((value) => IsSchema$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/const.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/contains.mjs
/**
* Returns true if the schema contains a valid contains property
* @specification Json Schema 7
*/
function IsContains(schema) {
	return HasPropertyKey$1(schema, "contains") && IsSchema$1(schema.contains);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/default.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/dependencies.mjs
/**
* Returns true if the schema contains a valid dependencies property
* @specification Json Schema 7
*/
function IsDependencies(schema) {
	return HasPropertyKey$1(schema, "dependencies") && IsObject$2(schema.dependencies) && Object.values(schema.dependencies).every((value) => IsSchema$1(value) || IsArray$1(value) && value.every((value$1) => IsString$1(value$1)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/dependentRequired.mjs
/**
...
function IsDependentRequired(schema) {
	return HasPropertyKey$1(schema, "dependentRequired") && IsObject$2(schema.dependentRequired) && Object.values(schema.dependentRequired).every((value) => IsArray$1(value) && value.every((value$1) => IsString$1(value$1)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/dependentSchemas.mjs
/**
* Returns true if the schema contains a valid dependentRequired property
* @specification Json Schema 2019-09
*/
function IsDependentSchemas(schema) {
	return HasPropertyKey$1(schema, "dependentSchemas") && IsObject$2(schema.dependentSchemas) && Object.values(schema.dependentSchemas).every((value) => IsSchema$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/dynamicAnchor.mjs
/**
* Returns true if the schema contains a valid $dynamicAnchor property
*/
function IsDynamicAnchor(schema) {
	return HasPropertyKey$1(schema, "$dynamicAnchor") && IsString$1(schema.$dynamicAnchor);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/else.mjs
/**
* Returns true if the schema contains a valid else property
* @specification Json Schema 7
*/
function IsElse(schema) {
	return HasPropertyKey$1(schema, "else") && IsSchema$1(schema.else);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/enum.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/exclusiveMaximum.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/exclusiveMinimum.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/format.mjs
/**
* Returns true if the schema contains a valid format property
* @specification Json Schema 7
*/
function IsFormat(schema) {
	return HasPropertyKey$1(schema, "format") && IsString$1(schema.format);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/id.mjs
/**
* Returns true if the schema contains a valid $id property
* @specification Json Schema 7
*/
function IsId(schema) {
	return HasPropertyKey$1(schema, "$id") && IsString$1(schema.$id);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/if.mjs
/**
* Returns true if the schema contains a valid $id property
* @specification Json Schema 7
*/
function IsIf(schema) {
	return HasPropertyKey$1(schema, "if") && IsSchema$1(schema.if);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/items.mjs
/**
* Returns true if the schema contains a valid items property
* @specification Json Schema 7
*/
function IsItems(schema) {
	return HasPropertyKey$1(schema, "items") && (IsSchema$1(schema.items) || IsArray$1(schema.items) && schema.items.every((value) => {
		return IsSchema$1(value);
	}));
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/maximum.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/maxContains.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/maxItems.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/maxLength.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/maxProperties.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/minimum.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/minContains.mjs
/**
* Returns true if the schema contains a valid maxContains property
* @specification Json Schema 2019-09
*/
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/minItems.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/minLength.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/minProperties.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/multipleOf.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/not.mjs
/**
* Returns true if the schema contains a valid not property
* @specification Json Schema 7
*/
function IsNot(schema) {
	return HasPropertyKey$1(schema, "not") && IsSchema$1(schema.not);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/oneOf.mjs
/**
* Returns true if the schema contains a valid oneOf property
* @specification Json Schema 7
*/
function IsOneOf(schema) {
	return HasPropertyKey$1(schema, "oneOf") && IsArray$1(schema.oneOf) && schema.oneOf.every((value) => IsSchema$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/pattern.mjs
/**
* Returns true if the schema contains a valid pattern property
* @specification Json Schema 7
*/
function IsPattern(schema) {
	return HasPropertyKey$1(schema, "pattern") && (IsString$1(schema.pattern) || schema.pattern instanceof RegExp);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/patternProperties.mjs
/**
* Returns true if the schema contains a valid patternProperties property
* @specification Json Schema 7
*/
function IsPatternProperties(schema) {
	return HasPropertyKey$1(schema, "patternProperties") && IsObject$2(schema.patternProperties) && Object.values(schema.patternProperties).every((value) => IsSchema$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/prefixItems.mjs
/**
* Returns true if the schema contains a valid prefixItems property
*/
function IsPrefixItems(schema) {
	return HasPropertyKey$1(schema, "prefixItems") && IsArray$1(schema.prefixItems) && schema.prefixItems.every((schema$1) => IsSchema$1(schema$1));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/properties.mjs
/**
* Returns true if the schema contains a valid properties property
* @specification Json Schema 7
*/
function IsProperties(schema) {
	return HasPropertyKey$1(schema, "properties") && IsObject$2(schema.properties) && Object.values(schema.properties).every((value) => IsSchema$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/propertyNames.mjs
/**
* Returns true if the schema contains a valid propertyNames property
* @specification Json Schema 7
*/
function IsPropertyNames(schema) {
	return HasPropertyKey$1(schema, "propertyNames") && (IsObject$2(schema.propertyNames) || IsSchema$1(schema.propertyNames));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/recursiveAnchor.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/recursiveRef.mjs
/**
* Returns true if the schema contains a valid $recursiveRef property
*/
function IsRecursiveRef(schema) {
	return HasPropertyKey$1(schema, "$recursiveRef") && IsString$1(schema.$recursiveRef);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/ref.mjs
/**
* Returns true if the schema contains a valid $ref property
* @specification Json Schema 7
*/
function IsRef$1(schema) {
	return HasPropertyKey$1(schema, "$ref") && IsString$1(schema.$ref);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/required.mjs
/**
* Returns true if the schema contains a valid required property
* @specification Json Schema 7
*/
function IsRequired(schema) {
	return HasPropertyKey$1(schema, "required") && IsArray$1(schema.required) && schema.required.every((value) => IsString$1(value));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/then.mjs
/**
* Returns true if the schema contains a valid then property
* @specification Json Schema 7
*/
function IsThen(schema) {
	return HasPropertyKey$1(schema, "then") && IsSchema$1(schema.then);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/type.mjs
/**
* Returns true if the schema contains a valid type property
* @specification Json Schema 7
*/
function IsType(schema) {
	return HasPropertyKey$1(schema, "type") && (IsString$1(schema.type) || IsArray$1(schema.type) && schema.type.every((value) => IsString$1(value)));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/uniqueItems.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/unevaluatedItems.mjs
/**
* Returns true if the schema contains a valid unevaluatedItems property
* @specification Json Schema 2019-09
*/
function IsUnevaluatedItems(schema) {
	return HasPropertyKey$1(schema, "unevaluatedItems") && IsSchema$1(schema.unevaluatedItems);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/types/unevaluatedProperties.mjs
/**
* Returns true if the schema contains a valid unevaluatedProperties property
* @specification Json Schema 2019-09
*/
function IsUnevaluatedProperties(schema) {
	return HasPropertyKey$1(schema, "unevaluatedProperties") && IsSchema$1(schema.unevaluatedProperties);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_context.mjs
...
function HasUnevaluatedFromArray(value) {
	return value.some((value$1) => HasUnevaluatedFromUnknown(value$1));
}
function HasUnevaluatedFromUnknown(value) {
	return IsArray$1(value) ? HasUnevaluatedFromArray(value) : IsObject$2(value) ? HasUnevaluatedFromObject(value) : false;
}
...
var BuildContext = class {
	...
	AddIndex(index$1) {
		return Call(Member("context", "AddIndex"), [index$1]);
	}
	AddKey(key) {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_externals.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_guard.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_refine.mjs
...
function ErrorRefine(stack, context, schemaPath, instancePath, schema, value) {
	return EveryAll(schema["~refine"], 0, (refinement, index$1) => {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_unique.mjs
let index = 0;
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/additionalItems.mjs
...
function BuildAdditionalItems(stack, context, schema, value) {
	...
	const [item, index$1] = [Unique(), Unique()];
	const isSchema = BuildSchema(stack, context, schema.additionalItems, item);
	const isLength = IsLessThan(index$1, Constant(schema.items.length));
	const addIndex = context.AddIndex(index$1);
	const guarded = context.UseUnevaluated() ? Or(isLength, And(isSchema, addIndex)) : Or(isLength, isSchema);
	return Call(Member(value, "every"), [ArrowFunction([item, index$1], guarded)]);
}
function CheckAdditionalItems(stack, context, schema, value) {
	if (!IsValid$4(schema)) return true;
	return value.every((item, index$1) => {
		return IsLessThan$1(index$1, schema.items.length) || CheckSchema(stack, context, schema.additionalItems, item) && context.AddIndex(index$1);
	});
}
function ErrorAdditionalItems(stack, context, schemaPath, instancePath, schema, value) {
	...
	return value.every((item, index$1) => {
		...
		const nextInstancePath = `${instancePath}/${index$1}`;
		return IsLessThan$1(index$1, schema.items.length) || ErrorSchema(stack, context, nextSchemaPath, nextInstancePath, schema.additionalItems, item) && context.AddIndex(index$1);
	});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/additionalProperties.mjs
...
function CanAdditionalPropertiesFast(context, schema, value) {
	return IsRequired(schema) && IsProperties(schema) && !IsPatternProperties(schema) && IsEqual(schema.additionalProperties, false) && IsEqual(Keys$1(schema.properties).length, schema.required.length);
}
function BuildAdditionalPropertiesFast(context, schema, value) {
	return IsEqual$1(Member(Call(Member("Object", "getOwnPropertyNames"), [value]), "length"), Constant(schema.required.length));
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_reducer.mjs
function Reducer(stack, context, schemas, value, check) {
	const results = ConstDeclaration("results", "[]");
	const context_n = schemas.map((_schema, index$1) => ConstDeclaration(`context_${index$1}`, New("CheckContext", [])));
	const condition_n = schemas.map((schema, index$1) => ConstDeclaration(`condition_${index$1}`, Call(ArrowFunction(["context"], BuildSchema(stack, context, schema, value)), [`context_${index$1}`])));
	const checks = schemas.map((_schema, index$1) => If$1(`condition_${index$1}`, Call(Member("results", "push"), [`context_${index$1}`])));
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/allOf.mjs
function BuildAllOfStandard(stack, context, schema, value) {
	return Reducer(stack, context, schema.allOf, value, IsEqual$1(Member("results", "length"), Constant(schema.allOf.length)));
}
function BuildAllOfFast(stack, context, schema, value) {
	return ReduceAnd(schema.allOf.map((schema$1) => BuildSchema(stack, context, schema$1, value)));
}
...
function CheckAllOf(stack, context, schema, value) {
	const results = schema.allOf.reduce((result, schema$1) => {
		const nextContext = new CheckContext();
		return CheckSchema(stack, nextContext, schema$1, value) ? [...result, nextContext] : result;
	}, []);
...
function ErrorAllOf(stack, context, schemaPath, instancePath, schema, value) {
	...
	const results = schema.allOf.reduce((result, schema$1, index$1) => {
		const nextSchemaPath = `${schemaPath}/allOf/${index$1}`;
		const nextContext = new AccumulatedErrorContext();
		const isSchema = ErrorSchema(stack, nextContext, nextSchemaPath, instancePath, schema$1, value);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/anyOf.mjs
...
function BuildAnyOfFast(stack, context, schema, value) {
	return ReduceOr(schema.anyOf.map((schema$1) => BuildSchema(stack, context, schema$1, value)));
}
...
function CheckAnyOf(stack, context, schema, value) {
	const results = schema.anyOf.reduce((result, schema$1, index$1) => {
		const nextContext = new CheckContext();
		return CheckSchema(stack, nextContext, schema$1, value) ? [...result, nextContext] : result;
	}, []);
...
function ErrorAnyOf(stack, context, schemaPath, instancePath, schema, value) {
	...
	const results = schema.anyOf.reduce((result, schema$1, index$1) => {
		const nextContext = new AccumulatedErrorContext();
		const isSchema = ErrorSchema(stack, nextContext, `${schemaPath}/anyOf/${index$1}`, instancePath, schema$1, value);
		if (!isSchema) failedContexts.push(nextContext);
		return isSchema ? [...result, nextContext] : result;
	}, []);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/boolean.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/const.mjs
function BuildConst(stack, context, schema, value) {
	return IsValueLike(schema.const) ? IsEqual$1(value, Constant(schema.const)) : IsDeepEqual(value, CreateVariable(schema.const));
}
function CheckConst(stack, context, schema, value) {
	return IsValueLike(schema.const) ? IsEqual(value, schema.const) : IsDeepEqual$1(value, schema.const);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/contains.mjs
...
function BuildContains(stack, context, schema, value) {
	...
	const item = Unique();
	const isLength = Not(IsEqual$1(Member(value, "length"), Constant(0)));
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/dependencies.mjs
function BuildDependencies(stack, context, schema, value) {
	const isLength = IsEqual$1(Member(Keys(value), "length"), Constant(0));
	const isEveryDependency = ReduceAnd(Entries$2(schema.dependencies).map(([key, schema$1]) => {
		const notKey = Not(HasPropertyKey(value, Constant(key)));
		const isSchema = BuildSchema(stack, context, schema$1, value);
		const isEveryKey = (schema$2) => ReduceAnd(schema$2.map((key$1) => HasPropertyKey(value, Constant(key$1))));
		return Or(notKey, IsArray$1(schema$1) ? isEveryKey(schema$1) : isSchema);
	}));
	return Or(isLength, isEveryDependency);
}
function CheckDependencies(stack, context, schema, value) {
	const isLength = IsEqual(Keys$1(value).length, 0);
	const isEvery = Every$1(Entries$2(schema.dependencies), 0, ([key, schema$1]) => {
		return !HasPropertyKey$1(value, key) || (IsArray$1(schema$1) ? schema$1.every((key$1) => HasPropertyKey$1(value, key$1)) : CheckSchema(stack, context, schema$1, value));
	});
	return isLength || isEvery;
}
function ErrorDependencies(stack, context, schemaPath, instancePath, schema, value) {
	const isLength = IsEqual(Keys$1(value).length, 0);
	const isEvery = EveryAll(Entries$2(schema.dependencies), 0, ([key, schema$1]) => {
		const nextSchemaPath = `${schemaPath}/dependencies/${key}`;
		return !HasPropertyKey$1(value, key) || (IsArray$1(schema$1) ? schema$1.every((dependency) => HasPropertyKey$1(value, dependency) || context.AddError({
		...
		})) : ErrorSchema(stack, context, nextSchemaPath, instancePath, schema$1, value));
	});
	return isLength || isEvery;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/dependentRequired.mjs
function BuildDependentRequired(stack, context, schema, value) {
	...
	const isEvery = ReduceAnd(Entries$2(schema.dependentRequired).map(([key, keys]) => {
		const notKey = Not(HasPropertyKey(value, Constant(key)));
		const everyKey = ReduceAnd(keys.map((key$1) => HasPropertyKey(value, Constant(key$1))));
...
function CheckDependentRequired(stack, context, schema, value) {
	...
	const isEvery = Every$1(Entries$2(schema.dependentRequired), 0, ([key, keys]) => {
		return !HasPropertyKey$1(value, key) || keys.every((key$1) => HasPropertyKey$1(value, key$1));
	});
	return isLength || isEvery;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/dependentSchemas.mjs
function BuildDependentSchemas(stack, context, schema, value) {
	const isLength = IsEqual$1(Member(Keys(value), "length"), Constant(0));
	const isEvery = ReduceAnd(Entries$2(schema.dependentSchemas).map(([key, schema$1]) => {
		const notKey = Not(HasPropertyKey(value, Constant(key)));
		const isSchema = BuildSchema(stack, context, schema$1, value);
...
function CheckDependentSchemas(stack, context, schema, value) {
	const isLength = IsEqual(Keys$1(value).length, 0);
	const isEvery = Every$1(Entries$2(schema.dependentSchemas), 0, ([key, schema$1]) => {
		return !HasPropertyKey$1(value, key) || CheckSchema(stack, context, schema$1, value);
	});
	return isLength || isEvery;
}
function ErrorDependentSchemas(stack, context, schemaPath, instancePath, schema, value) {
	const isLength = IsEqual(Keys$1(value).length, 0);
	const isEvery = EveryAll(Entries$2(schema.dependentSchemas), 0, ([key, schema$1]) => {
		const nextSchemaPath = `${schemaPath}/dependentSchemas/${key}`;
		return !HasPropertyKey$1(value, key) || ErrorSchema(stack, context, nextSchemaPath, instancePath, schema$1, value);
	});
	return isLength || isEvery;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/enum.mjs
function BuildEnum(stack, context, schema, value) {
	return ReduceOr(schema.enum.map((option) => {
		if (IsValueLike(option)) return IsEqual$1(value, Constant(option));
		const variable = CreateVariable(option);
		return IsDeepEqual(value, variable);
	}));
}
function CheckEnum(stack, context, schema, value) {
	return schema.enum.some((option) => IsValueLike(option) ? IsEqual(value, option) : IsDeepEqual$1(value, option));
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/exclusiveMaximum.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/exclusiveMinimum.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/date.mjs
const DAYS = [
	0,
	31,
	28,
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/time.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/date-time.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/duration.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/email.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/hostname.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/idn-email.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/idn-hostname.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/ipv4.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/ipv6.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/iri-reference.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/iri.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/json-pointer-uri-fragment.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/json-pointer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/regex.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/relative-json-pointer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/uri-reference.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/uri-template.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/uri.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/url.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/uuid.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/_registry.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/format/format.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/format.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/if.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/items.mjs
function BuildItemsSized(stack, context, schema, value) {
	return ReduceAnd(schema.items.map((schema$1, index$1) => {
		const isLength = IsLessEqualThan(Member(value, "length"), Constant(index$1));
		const isSchema = BuildSchema(stack, context, schema$1, `${value}[${index$1}]`);
		const addIndex = context.AddIndex(Constant(index$1));
		const guarded = context.UseUnevaluated() ? And(isSchema, addIndex) : isSchema;
		return Or(isLength, guarded);
	}));
}
function CheckItemsSized(stack, context, schema, value) {
	return Every$1(schema.items, 0, (schema$1, index$1) => {
		return IsLessEqualThan$1(value.length, index$1) || CheckSchema(stack, context, schema$1, value[index$1]) && context.AddIndex(index$1);
	});
}
function ErrorItemsSized(stack, context, schemaPath, instancePath, schema, value) {
	return EveryAll(schema.items, 0, (schema$1, index$1) => {
		const nextSchemaPath = `${schemaPath}/items/${index$1}`;
		const nextInstancePath = `${instancePath}/${index$1}`;
		return IsLessEqualThan$1(value.length, index$1) || ErrorSchema(stack, context, nextSchemaPath, nextInstancePath, schema$1, value[index$1]) && context.AddIndex(index$1);
	});
}
...
function CheckItemsUnsized(stack, context, schema, value) {
	const offset = IsPrefixItems(schema) ? schema.prefixItems.length : 0;
	return Every$1(value, offset, (element, index$1) => {
		return CheckSchema(stack, context, schema.items, element) && context.AddIndex(index$1);
	});
}
function ErrorItemsUnsized(stack, context, schemaPath, instancePath, schema, value) {
	const offset = IsPrefixItems(schema) ? schema.prefixItems.length : 0;
	return EveryAll(value, offset, (element, index$1) => {
		return ErrorSchema(stack, context, `${schemaPath}/items`, `${instancePath}/${index$1}`, schema.items, element) && context.AddIndex(index$1);
	});
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/maxContains.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/maximum.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/maxItems.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/maxLength.mjs
function BuildMaxLength(stack, context, schema, value) {
	return IsLessEqualThan(StringGraphemeCount(value), Constant(schema.maxLength));
}
function CheckMaxLength(stack, context, schema, value) {
	return IsLessEqualThan$1(StringGraphemeCount$1(value), schema.maxLength);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/maxProperties.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/minContains.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/minimum.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/minItems.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/minLength.mjs
function BuildMinLength(stack, context, schema, value) {
	return IsGreaterEqualThan(StringGraphemeCount(value), Constant(schema.minLength));
}
function CheckMinLength(stack, context, schema, value) {
	return IsGreaterEqualThan$1(StringGraphemeCount$1(value), schema.minLength);
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/minProperties.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/multipleOf.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/not.mjs
function BuildNotUnevaluated(stack, context, schema, value) {
	return Reducer(stack, context, [schema.not], value, Not(IsEqual$1(Member("results", "length"), Constant(1))));
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/oneOf.mjs
function BuildOneOfUnevaluated(stack, context, schema, value) {
	return Reducer(stack, context, schema.oneOf, value, IsEqual$1(Member("results", "length"), Constant(1)));
}
function BuildOneOfFast(stack, context, schema, value) {
	const results = ArrayLiteral(schema.oneOf.map((schema$1) => BuildSchema(stack, context, schema$1, value)));
	const count = Call(Member(results, "reduce"), [ArrowFunction(["count", "result"], Ternary(IsEqual$1("result", Constant(true)), PrefixIncrement("count"), "count")), Constant(0)]);
	return IsEqual$1(count, Constant(1));
}
...
function CheckOneOf(stack, context, schema, value) {
	const passedContexts = schema.oneOf.reduce((result, schema$1) => {
		const nextContext = new CheckContext();
		return CheckSchema(stack, nextContext, schema$1, value) ? [...result, nextContext] : result;
	}, []);
...
function ErrorOneOf(stack, context, schemaPath, instancePath, schema, value) {
	...
	const passedContexts = schema.oneOf.reduce((result, schema$1, index$1) => {
		const nextContext = new AccumulatedErrorContext();
		const isSchema = ErrorSchema(stack, nextContext, `${schemaPath}/oneOf/${index$1}`, instancePath, schema$1, value);
		if (isSchema) passingSchemas.push(index$1);
		if (!isSchema) failedContexts.push(nextContext);
		return isSchema ? [...result, nextContext] : result;
	}, []);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/pattern.mjs
function BuildPattern(stack, context, schema, value) {
	const regexp = CreateVariable(IsString$1(schema.pattern) ? new RegExp(schema.pattern) : schema.pattern);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/patternProperties.mjs
function BuildPatternProperties(stack, context, schema, value) {
	return ReduceAnd(Entries$2(schema.patternProperties).map(([pattern, schema$1]) => {
		const [key, prop] = [Unique(), Unique()];
		const regexp = CreateVariable(new RegExp(pattern));
		const notKey = Not(Call(Member(regexp, "test"), [key]));
		const isSchema = BuildSchema(stack, context, schema$1, prop);
		const addKey = context.AddKey(key);
...
function CheckPatternProperties(stack, context, schema, value) {
	return Every$1(Entries$2(schema.patternProperties), 0, ([pattern, schema$1]) => {
		const regexp = new RegExp(pattern);
		return Every$1(Entries$2(value), 0, ([key, prop]) => {
			return !regexp.test(key) || CheckSchema(stack, context, schema$1, prop) && context.AddKey(key);
		});
	});
}
function ErrorPatternProperties(stack, context, schemaPath, instancePath, schema, value) {
	return EveryAll(Entries$2(schema.patternProperties), 0, ([pattern, schema$1]) => {
		const nextSchemaPath = `${schemaPath}/patternProperties/${pattern}`;
		const regexp = new RegExp(pattern);
		return EveryAll(Entries$2(value), 0, ([key, value$1]) => {
			const nextInstancePath = `${instancePath}/${key}`;
			return !regexp.test(key) || ErrorSchema(stack, context, nextSchemaPath, nextInstancePath, schema$1, value$1) && context.AddKey(key);
		});
	});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/prefixItems.mjs
function BuildPrefixItems(stack, context, schema, value) {
	return ReduceAnd(schema.prefixItems.map((schema$1, index$1) => {
		const isLength = IsLessEqualThan(Member(value, "length"), Constant(index$1));
		const isSchema = BuildSchema(stack, context, schema$1, `${value}[${index$1}]`);
		const addIndex = context.AddIndex(Constant(index$1));
		const guarded = context.UseUnevaluated() ? And(isSchema, addIndex) : isSchema;
...
function CheckPrefixItems(stack, context, schema, value) {
	return IsEqual(value.length, 0) || Every$1(schema.prefixItems, 0, (schema$1, index$1) => {
		return IsLessEqualThan$1(value.length, index$1) || CheckSchema(stack, context, schema$1, value[index$1]) && context.AddIndex(index$1);
	});
}
function ErrorPrefixItems(stack, context, schemaPath, instancePath, schema, value) {
	return IsEqual(value.length, 0) || EveryAll(schema.prefixItems, 0, (schema$1, index$1) => {
		const nextSchemaPath = `${schemaPath}/prefixItems/${index$1}`;
		const nextInstancePath = `${instancePath}/${index$1}`;
		return IsLessEqualThan$1(value.length, index$1) || ErrorSchema(stack, context, nextSchemaPath, nextInstancePath, schema$1, value[index$1]) && context.AddIndex(index$1);
	});
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_exact_optional.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/properties.mjs
function BuildProperties(stack, context, schema, value) {
	const required = IsRequired(schema) ? schema.required : [];
	const everyKey = Entries$2(schema.properties).map(([key, schema$1]) => {
		const notKey = Not(HasPropertyKey(value, Constant(key)));
		const isSchema = BuildSchema(stack, context, schema$1, Member(value, key));
...
function CheckProperties(stack, context, schema, value) {
	const required = IsRequired(schema) ? schema.required : [];
	return Every$1(Entries$2(schema.properties), 0, ([key, schema$1]) => {
		const isProperty = !HasPropertyKey$1(value, key) || CheckSchema(stack, context, schema$1, value[key]) && context.AddKey(key);
...
function ErrorProperties(stack, context, schemaPath, instancePath, schema, value) {
	const required = IsRequired(schema) ? schema.required : [];
	return EveryAll(Entries$2(schema.properties), 0, ([key, schema$1]) => {
		const nextSchemaPath = `${schemaPath}/properties/${key}`;
		const nextInstancePath = `${instancePath}/${key}`;
		const isProperty = () => !HasPropertyKey$1(value, key) || ErrorSchema(stack, context, nextSchemaPath, nextInstancePath, schema$1, value[key]) && context.AddKey(key);
		return IsExactOptional(required, key) ? isProperty() : InexactOptionalCheck(value, key) || isProperty();
	});
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/propertyNames.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/recursiveRef.mjs
...
function CheckRecursiveRef(stack, context, schema, value) {
	const target = stack.RecursiveRef(schema.$recursiveRef) ?? false;
	return IsSchema$1(target) && CheckSchema(stack, context, target, value);
}
function ErrorRecursiveRef(stack, context, schemaPath, instancePath, schema, value) {
	const target = stack.RecursiveRef(schema.$recursiveRef) ?? false;
	return IsSchema$1(target) && ErrorSchema(stack, context, "#", instancePath, target, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/ref.mjs
...
function CheckRef(stack, context, schema, value) {
	const target = stack.Ref(schema.$ref) ?? false;
	const nextContext = new CheckContext();
	const result = IsSchema$1(target) && CheckSchema(stack, nextContext, target, value);
...
function ErrorRef(stack, context, schemaPath, instancePath, schema, value) {
	const target = stack.Ref(schema.$ref) ?? false;
	const nextContext = new AccumulatedErrorContext();
	const result = IsSchema$1(target) && ErrorSchema(stack, nextContext, "#", instancePath, target, value);
	if (result) context.Merge([nextContext]);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/required.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/type.mjs
function BuildTypeName(stack, context, type, value) {
	return IsEqual(type, "object") ? IsObjectNotArray(value) : IsEqual(type, "array") ? IsArray$2(value) : IsEqual(type, "boolean") ? IsBoolean$2(value) : IsEqual(type, "integer") ? IsInteger$1(value) : IsEqual(type, "number") ? IsNumber$2(value) : IsEqual(type, "null") ? IsNull$1(value) : IsEqual(type, "string") ? IsString$3(value) : IsEqual(type, "asyncIterator") ? IsAsyncIterator$1(value) : IsEqual(type, "bigint") ? IsBigInt$1(value) : IsEqual(type, "constructor") ? IsConstructor$1(value) : IsEqual(type, "function") ? IsFunction$1(value) : IsEqual(type, "iterator") ? IsIterator$1(value) : IsEqual(type, "symbol") ? IsSymbol$1(value) : IsEqual(type, "undefined") ? IsUndefined$1(value) : IsEqual(type, "void") ? IsUndefined$1(value) : Constant(true);
}
function CheckTypeName(stack, context, type, schema, value) {
	return IsEqual(type, "object") ? IsObjectNotArray$1(value) : IsEqual(type, "array") ? IsArray$1(value) : IsEqual(type, "boolean") ? IsBoolean$3(value) : IsEqual(type, "integer") ? IsInteger$2(value) : IsEqual(type, "number") ? IsNumber$3(value) : IsEqual(type, "null") ? IsNull$2(value) : IsEqual(type, "string") ? IsString$1(value) : IsEqual(type, "asyncIterator") ? IsAsyncIterator$2(value) : IsEqual(type, "bigint") ? IsBigInt$2(value) : IsEqual(type, "constructor") ? IsConstructor$2(value) : IsEqual(type, "function") ? IsFunction$2(value) : IsEqual(type, "iterator") ? IsIterator$2(value) : IsEqual(type, "symbol") ? IsSymbol$2(value) : IsEqual(type, "undefined") ? IsUndefined$2(value) : IsEqual(type, "void") ? IsUndefined$2(value) : true;
}
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/unevaluatedItems.mjs
function BuildUnevaluatedItems(stack, context, schema, value) {
	const [index$1, item] = [Unique(), Unique()];
	const indices = Call(Member("context", "GetIndices"), []);
	const hasIndex = Call(Member("indices", "has"), [index$1]);
	const isSchema = BuildSchema(stack, context, schema.unevaluatedItems, item);
	const addIndex = Call(Member("context", "AddIndex"), [index$1]);
	const isEvery = Every(value, Constant(0), [item, index$1], And(Or(hasIndex, isSchema), addIndex));
...
function CheckUnevaluatedItems(stack, context, schema, value) {
	...
	return Every$1(value, 0, (item, index$1) => {
		return (indices.has(index$1) || CheckSchema(stack, context, schema.unevaluatedItems, item)) && context.AddIndex(index$1);
	});
}
function ErrorUnevaluatedItems(stack, context, schemaPath, instancePath, schema, value) {
	const indices = context.GetIndices();
	const unevaluatedItems = [];
	return EveryAll(value, 0, (item, index$1) => {
		const nextContext = new AccumulatedErrorContext();
		const isEvaluatedItem = (indices.has(index$1) || ErrorSchema(stack, nextContext, schemaPath, instancePath, schema.unevaluatedItems, item)) && context.AddIndex(index$1);
		if (!isEvaluatedItem) unevaluatedItems.push(index$1);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/unevaluatedProperties.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/uniqueItems.mjs
...
function ErrorUniqueItems(stack, context, schemaPath, instancePath, schema, value) {
	...
	const duplicateItems = value.reduce((result, value$1, index$1) => {
		const hash = Hash(value$1);
		if (set.has(hash)) return [...result, index$1];
		set.add(hash);
		return result;
	}, []);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/schema.mjs
function HasTypeName(schema, typename) {
	return IsType(schema) && (IsArray$1(schema.type) && schema.type.includes(typename) || IsEqual(schema.type, typename));
}
...
function BuildSchema(stack, context, schema, value) {
	...
	if (HasArrayKeywords(schema)) {
		...
		const reduced = ReduceAnd(constraints);
		const guarded = Or(Not(IsArray$2(value)), reduced);
	...
	if (HasStringKeywords(schema)) {
		...
		const reduced = ReduceAnd(constraints);
		const guarded = Or(Not(IsString$3(value)), reduced);
	...
	if (IsRef$1(schema)) conditions.push(BuildRef(stack, context, schema, value));
	...
	if (IsUnevaluatedItems(schema)) conditions.push(Or(Not(IsArray$2(value)), BuildUnevaluatedItems(stack, context, schema, value)));
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/pointer/pointer.mjs
function GetIndex(index$1, value) {
	return IsObject$2(value) ? value[index$1] : void 0;
}
function GetIndices(indices, value) {
	return indices.reduce((value$1, index$1) => GetIndex(index$1, value$1), value);
}
/** Returns an array of path indices for the given pointer */
function Indices(pointer) {
	if (IsEqual(pointer.length, 0)) return [];
	const indices = pointer.split("/").map((index$1) => index$1.replace(/~1/g, "/").replace(/~0/g, "~"));
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/resolve/ref.mjs
...
function MatchHash(schema, base, ref) {
	...
	return ref.hash.startsWith("#") ? Get$1(schema, decodeURIComponent(ref.hash.slice(1))) : void 0;
}
...
function FromValue$1(schema, base, ref) {
	...
	if (IsArray$1(schema)) return FromArray$7(schema, base, ref);
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/engine/_stack.mjs
var Stack = class {
	...
	FromRef(ref) {
		return !ref.startsWith("#") ? Ref$1(this.schema, ref) : Ref$1(this.Base(), ref);
	}
	Ref(ref) {
		return this.FromContext(ref) ?? this.FromRef(ref);
	}
	RecursiveRef(recursiveRef) {
		if (IsRecursiveAnchorTrue(this.Base())) return Ref$1(this.recursiveAnchors[0], recursiveRef);
		return Ref$1(this.Base(), recursiveRef);
	}
};

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/build.mjs
...
var BuildResult = class {
	constructor(context, schema, external, functions$1, call, useUnevaluated) {
		this.context = context;
		this.schema = schema;
	...
	Evaluate() {
		...
		const Check$2 = CreateCheck(this, Code);
		return {
...
function Build(...args) {
	const [context, schema] = Match$1(args, {
		2: (context$1, schema$1) => [context$1, schema$1],
		1: (schema$1) => [{}, schema$1]
	});
	ResetExternal();
	ResetFunctions();
	...
	const functions$1 = GetFunctions();
	return new BuildResult(context, schema, GetExternal(), functions$1, call, build.UseUnevaluated());
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/check.mjs
/** Checks a value against the provided schema */
function Check$1(...args) {
	const [context, schema, value] = Match$1(args, {
		3: (context$1, schema$1, value$1) => [
			context$1,
			schema$1,
			value$1
		],
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/schema/errors.mjs
...
function Errors$1(...args) {
	...
	const errorContext = new ErrorContext((error) => {
		if (IsGreaterEqualThan$1(errors.length, settings$1.maxErrors)) return;
		return errors.push({
			...error,
			message: locale$1(error)
		});
	});
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/check/check.mjs
/** Checks a value matches the provided type. */
function Check(...args) {
	const [context, type, value] = Match$1(args, {
		3: (context$1, type$1, value$1) => [
			context$1,
			type$1,
			value$1
		],
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/errors/errors.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/assert/assert.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-array.mjs
function FromArray$5(context, type, value) {
	if (!IsArray$1(value)) return value;
	return value.map((value$1) => FromType$5(context, type.items, value$1));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-base.mjs
function FromBase$3(context, type, value) {
	return type.Clean(value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-intersect.mjs
...
function FromIntersect$5(context, type, value) {
	return FromType$5(context, EvaluateIntersection(type), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/additional.mjs
function GetAdditionalProperties(type) {
	return HasPropertyKey$1(type, "additionalProperties") ? type.additionalProperties : void 0;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-object.mjs
function FromObject$5(context, type, value) {
	...
	for (const key of Keys$1(value)) {
		...
		if (IsBoolean$3(additionalProperties) && IsEqual(additionalProperties, true) || IsSchema(additionalProperties) && Check(context, additionalProperties, value[key])) {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-record.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-ref.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-tuple.mjs
function FromTuple$5(context, schema, value) {
	if (!IsArray$1(value)) return value;
	const length = Math.min(value.length, schema.items.length);
	for (let index$1 = 0; index$1 < length; index$1++) value[index$1] = FromType$5(context, schema.items[index$1], value[index$1]);
	return IsGreaterThan$1(value.length, length) ? value.slice(0, length) : value;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clone/clone.mjs
...
function Clone(value) {
	return IsTypeArray(value) ? FromTypedArray(value) : IsMap(value) ? FromMap(value) : IsSet(value) ? FromSet(value) : IsArray$1(value) ? FromArray$6(value) : IsObject$2(value) ? FromObject$6(value) : FromValue(value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-union.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/from-type.mjs
function FromType$5(context, type, value) {
	return IsArray(type) ? FromArray$5(context, type, value) : IsBase(type) ? FromBase$3(context, type, value) : IsCyclic(type) ? FromCyclic$5(context, type, value) : IsIntersect(type) ? FromIntersect$5(context, type, value) : IsObject(type) ? FromObject$5(context, type, value) : IsRecord(type) ? FromRecord$5(context, type, value) : IsRef(type) ? FromRef$5(context, type, value) : IsTuple(type) ? FromTuple$5(context, type, value) : IsUnion(type) ? FromUnion$5(context, type, value) : value;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/clean/clean.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-array.mjs
function FromArray$4(context, type, value) {
	return IsArray$1(value) ? value.map((value$1) => FromType$4(context, type.items, value$1)) : value;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-base.mjs
function FromBase$2(context, type, value) {
	return type.Convert(value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-result.mjs
function IsOk(value) {
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-bigint.mjs
...
function TryBigInt(value) {
	return IsBigInt$2(value) ? FromBigInt$7(value) : IsBoolean$3(value) ? FromBoolean$7(value) : IsNumber$3(value) ? FromNumber$7(value) : IsNull$2(value) ? FromNull$7(value) : IsString$1(value) ? FromString$7(value) : IsUndefined$2(value) ? FromUndefined$7(value) : /* @__PURE__ */ Fail();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-boolean.mjs
...
function TryBoolean(value) {
	return IsBigInt$2(value) ? FromBigInt$6(value) : IsBoolean$3(value) ? FromBoolean$6(value) : IsNumber$3(value) ? FromNumber$6(value) : IsNull$2(value) ? FromNull$6(value) : IsString$1(value) ? FromString$6(value) : IsUndefined$2(value) ? FromUndefined$6(value) : /* @__PURE__ */ Fail();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-null.mjs
...
function TryNull(value) {
	return IsBigInt$2(value) ? FromBigInt$5(value) : IsBoolean$3(value) ? FromBoolean$5(value) : IsNumber$3(value) ? FromNumber$5(value) : IsNull$2(value) ? FromNull$5(value) : IsString$1(value) ? FromString$5(value) : IsUndefined$2(value) ? FromUndefined$5(value) : /* @__PURE__ */ Fail();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-number.mjs
...
function TryNumber(value) {
	return IsBigInt$2(value) ? FromBigInt$4(value) : IsBoolean$3(value) ? FromBoolean$4(value) : IsNumber$3(value) ? FromNumber$4(value) : IsNull$2(value) ? FromNull$4(value) : IsString$1(value) ? FromString$4(value) : IsUndefined$2(value) ? FromUndefined$4(value) : /* @__PURE__ */ Fail();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-string.mjs
...
function TryString(value) {
	return IsBigInt$2(value) ? FromBigInt$3(value) : IsBoolean$3(value) ? FromBoolean$3(value) : IsNumber$3(value) ? FromNumber$3(value) : IsNull$2(value) ? FromNull$3(value) : IsString$1(value) ? FromString$3(value) : IsUndefined$2(value) ? FromUndefined$3(value) : /* @__PURE__ */ Fail();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/try/try-undefined.mjs
...
function TryUndefined(value) {
	return IsBigInt$2(value) ? FromBigInt$2(value) : IsBoolean$3(value) ? FromBoolean$2(value) : IsNumber$3(value) ? FromNumber$2(value) : IsNull$2(value) ? FromNull$2(value) : IsString$1(value) ? FromString$2(value) : IsUndefined$2(value) ? FromUndefined$2(value) : /* @__PURE__ */ Fail();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-bigint.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-boolean.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-union.mjs
function FromUnion$4(context, type, value) {
	if (type.anyOf.some((type$1) => Check(context, type$1, value))) return value;
	const selected = type.anyOf.map((type$1) => FromType$4(context, type$1, Clone(value))).find((value$1) => Check(context, type, value$1));
	return IsUndefined$2(selected) ? value : selected;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-enum.mjs
function FromEnum$1(context, type, value) {
	return FromUnion$4(context, EnumToUnion(type), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-integer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-intersect.mjs
function FromIntersect$4(context, type, value) {
	return FromType$4(context, Evaluate(type), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-literal.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-null.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-number.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-additional.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/shared/optional-undefined.mjs
function IsOptionalUndefined(property, key, value) {
	return IsOptional(property) && IsUndefined$2(value[key]);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-record.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-ref.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-string.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-template-literal.mjs
function FromTemplateLiteral$1(context, type, value) {
	return FromType$4(context, TemplateLiteralDecode(type.pattern), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-tuple.mjs
function FromTuple$4(context, type, value) {
	if (!IsArray$1(value)) return value;
	for (let index$1 = 0; index$1 < Math.min(type.items.length, value.length); index$1++) value[index$1] = FromType$4(context, type.items[index$1], value[index$1]);
	return value;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-undefined.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-void.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/from-type.mjs
function FromType$4(context, type, value) {
	return IsArray(type) ? FromArray$4(context, type, value) : IsBase(type) ? FromBase$2(context, type, value) : IsBigInt(type) ? FromBigInt$1(context, type, value) : IsBoolean(type) ? FromBoolean$1(context, type, value) : IsCyclic(type) ? FromCyclic$4(context, type, value) : IsEnum$1(type) ? FromEnum$1(context, type, value) : IsInteger(type) ? FromInteger$1(context, type, value) : IsIntersect(type) ? FromIntersect$4(context, type, value) : IsLiteral(type) ? FromLiteral$1(context, type, value) : IsNull(type) ? FromNull$1(context, type, value) : IsNumber(type) ? FromNumber$1(context, type, value) : IsObject(type) ? FromObject$4(context, type, value) : IsRecord(type) ? FromRecord$4(context, type, value) : IsRef(type) ? FromRef$4(context, type, value) : IsString(type) ? FromString$1(context, type, value) : IsTemplateLiteral(type) ? FromTemplateLiteral$1(context, type, value) : IsTuple(type) ? FromTuple$4(context, type, value) : IsUndefined(type) ? FromUndefined$1(context, type, value) : IsUnion(type) ? FromUnion$4(context, type, value) : IsVoid(type) ? FromVoid$1(context, type, value) : value;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/convert/convert.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-array.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-base.mjs
function FromBase$1(context, type, value) {
	return type.Default(value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-default.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-intersect.mjs
function FromIntersect$3(context, type, value) {
	return FromType$3(context, Evaluate(type), value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-object.mjs
function FromObject$3(context, type, value) {
	...
	for (const key of knownPropertyKeys) {
		...
		if (IsUndefined$2(propertyValue)) continue;
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-record.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-ref.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-tuple.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-union.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/from-type.mjs
function FromType$3(context, type, value) {
	const defaulted = IsDefault(type) ? FromDefault$1(type, value) : value;
	return IsArray(type) ? FromArray$3(context, type, defaulted) : IsBase(type) ? FromBase$1(context, type, defaulted) : IsCyclic(type) ? FromCyclic$3(context, type, defaulted) : IsIntersect(type) ? FromIntersect$3(context, type, defaulted) : IsObject(type) ? FromObject$3(context, type, defaulted) : IsRecord(type) ? FromRecord$3(context, type, defaulted) : IsRef(type) ? FromRef$3(context, type, defaulted) : IsTuple(type) ? FromTuple$3(context, type, defaulted) : IsUnion(type) ? FromUnion$3(context, type, defaulted) : defaulted;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/default/default.mjs
/**
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/pipeline/pipeline.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/callback.mjs
...
function Callback(direction, context, type, value) {
	...
	return IsEqual(direction, "Decode") ? Decode$7(context, type, value) : Encode$7(context, type, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-array.mjs
...
function FromArray$2(direction, context, type, value) {
	return IsEqual(direction, "Decode") ? Decode$6(direction, context, type, value) : Encode$6(direction, context, type, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-intersect.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-record.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-ref.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-tuple.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-union.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/from-type.mjs
function FromType$2(direction, context, type, value) {
	return IsArray(type) ? FromArray$2(direction, context, type, value) : IsCyclic(type) ? FromCyclic$2(direction, context, type, value) : IsIntersect(type) ? FromIntersect$2(direction, context, type, value) : IsObject(type) ? FromObject$2(direction, context, type, value) : IsRecord(type) ? FromRecord$2(direction, context, type, value) : IsRef(type) ? FromRef$2(direction, context, type, value) : IsTuple(type) ? FromTuple$2(direction, context, type, value) : IsUnion(type) ? FromUnion$2(direction, context, type, value) : Callback(direction, context, type, value);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/decode.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/encode.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/codec/has.mjs
...
function FromIntersect$1(context, type) {
	return IsCodec(type) || type.allOf.some((type$1) => FromType$1(context, type$1));
}
...
function FromTuple$1(context, type) {
	return IsCodec(type) || type.items.some((type$1) => FromType$1(context, type$1));
}
function FromUnion$1(context, type) {
	return IsCodec(type) || type.anyOf.some((type$1) => FromType$1(context, type$1));
}
function FromType$1(context, type) {
	return IsArray(type) ? FromArray$1(context, type) : IsCyclic(type) ? FromCyclic$1(context, type) : IsIntersect(type) ? FromIntersect$1(context, type) : IsObject(type) ? FromObject$1(context, type) : IsRecord(type) ? FromRecord$1(context, type) : IsRef(type) ? FromRef$1(context, type) : IsTuple(type) ? FromTuple$1(context, type) : IsUnion(type) ? FromUnion$1(context, type) : IsCodec(type);
}
const visited = /* @__PURE__ */ new Set();
/** Returns true if this type contains a Codec */
function HasCodec(...args) {
	const [context, type] = Match$1(args, {
		2: (context$1, type$1) => [context$1, type$1],
		1: (type$1) => [{}, type$1]
	});
	visited.clear();
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/error.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-default.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-array.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-async-iterator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-base.mjs
function FromBase(context, type) {
	return type.Create();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-bigint.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-boolean.mjs
function FromBoolean(context, type) {
	return false;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-constructor.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-cyclic.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-enum.mjs
function FromEnum(context, type) {
	return FromType(context, EnumToUnion(type));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-function.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-integer.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-intersect.mjs
function FromIntersect(context, type) {
	return FromType(context, Evaluate(type));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-iterator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-literal.mjs
function FromLiteral(context, type) {
	return type.const;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-never.mjs
function FromNever(context, type) {
	throw new CreateError(type, "Cannot create TNever types");
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-null.mjs
function FromNull(context, type) {
	return null;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-number.mjs
function FromNumber(context, type) {
	return IsExclusiveMinimum(type) && IsNumber$3(type.exclusiveMinimum) ? type.exclusiveMinimum + 1 : IsMinimum(type) ? type.minimum : 0;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-object.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-promise.mjs
function FromPromise(context, type) {
	return Promise.resolve(FromType(context, type.item));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-record.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-ref.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-string.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-symbol.mjs
function FromSymbol(context, type) {
	return Symbol();
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-template-literal.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-tuple.mjs
function FromTuple(context, type) {
	return Array.from({ length: type.minItems }, (_, i) => FromType(context, type.items[i]));
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-undefined.mjs
function FromUndefined(context, type) {}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-union.mjs
function FromUnion(context, type) {
	if (IsEqual(type.anyOf.length, 0)) throw Error("Unable to create Union with no variants");
	return FromType(context, type.anyOf[0]);
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-void.mjs
function FromVoid(context, type) {}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/from-type.mjs
function FromType(context, type) {
	return IsDefault(type) ? FromDefault(context, type) : IsArray(type) ? FromArray(context, type) : IsAsyncIterator(type) ? FromAsyncIterator(context, type) : IsBase(type) ? FromBase(context, type) : IsBigInt(type) ? FromBigInt(context, type) : IsBoolean(type) ? FromBoolean(context, type) : IsConstructor(type) ? FromConstructor(context, type) : IsCyclic(type) ? FromCyclic(context, type) : IsEnum$1(type) ? FromEnum(context, type) : IsFunction(type) ? FromFunction(context, type) : IsInteger(type) ? FromInteger(context, type) : IsIntersect(type) ? FromIntersect(context, type) : IsIterator(type) ? FromIterator(context, type) : IsLiteral(type) ? FromLiteral(context, type) : IsNever(type) ? FromNever(context, type) : IsNull(type) ? FromNull(context, type) : IsNumber(type) ? FromNumber(context, type) : IsObject(type) ? FromObject(context, type) : IsPromise(type) ? FromPromise(context, type) : IsRecord(type) ? FromRecord(context, type) : IsRef(type) ? FromRef(context, type) : IsString(type) ? FromString(context, type) : IsSymbol(type) ? FromSymbol(context, type) : IsTemplateLiteral(type) ? FromTemplateLiteral(context, type) : IsTuple(type) ? FromTuple(context, type) : IsUndefined(type) ? /* @__PURE__ */ FromUndefined(context, type) : IsUnion(type) ? FromUnion(context, type) : IsVoid(type) ? /* @__PURE__ */ FromVoid(context, type) : void 0;
}

//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/create/create.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/parse/parse.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/value/delta/edit.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/compile/validator.mjs
...
//#endregion
//#region ../node_modules/.pnpm/typebox@1.0.51/node_modules/typebox/build/compile/compile.mjs
