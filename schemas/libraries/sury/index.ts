...
export function getSurySchema() {
  const imageSchema = S.schema({
    id: S.number,
    created: S.date,
    title: S.string.with(S.minLength, 1).with(S.maxLength, 100),
  ...
  const ratingSchema = S.schema({
    ...
    title: S.string.with(S.minLength, 1).with(S.maxLength, 100),
    text: S.string.with(S.minLength, 1).with(S.maxLength, 1000),
  ...
  return S.schema({
    ...
    created: S.date,
    title: S.string.with(S.minLength, 1).with(S.maxLength, 100),
    brand: S.string.with(S.minLength, 1).with(S.maxLength, 30),
    description: S.string.with(S.minLength, 1).with(S.maxLength, 500),
    ...
    tags: S.array(S.string.with(S.minLength, 1).with(S.maxLength, 30)),
    images: S.array(imageSchema),
