...
function __zcSw_0(input, path, _e) {
  if (!Array.isArray(input)) _e.push(__zcIT("array", input, path));
    ...
    input = input.slice();
    for (var __i_0 = 0; __i_0 < input.length; __i_0++)
      input[__i_0] = __zcSw_1(input[__i_0], path.concat(__i_0), _e);
  }
  return input;
}
function __zcSw_1(input, path, _e) {
  if (typeof input !== "object" || input === null || Array.isArray(input))
    _e.push(__zcIT("object", input, path));
  else {
    var __sv_2 = input["id"];
    if (typeof __sv_2 !== "number") _e.push(__zcIT("number", __sv_2, path.concat("id")));
    else if (Number.isNaN(__sv_2))
      _e.push({
        expected: "number",
        code: "invalid_type",
        received: "NaN",
    ...
    else if (!Number.isFinite(__sv_2))
      _e.push({
        expected: "number",
        code: "invalid_type",
        received: "Infinity",
    ...
    if (typeof __sv_4 !== "string") {
      ...
      if (__sv_4 !== void 0 && __sv_4 !== null && __sv_4.length !== void 0) {
        if (__sv_4.length < 1)
          _e.push(__zcTS(1, __zcLo(__sv_4), true, __sv_4, path.concat("title")));
        if (__sv_4.length > 100)
          _e.push(__zcTB(100, __zcLo(__sv_4), true, __sv_4, path.concat("title")));
      }
    } else {
    ...
    if (__sv_5 !== "jpg" && __sv_5 !== "png")
      _e.push(__zcIV(["jpg", "png"], __sv_5, path.concat("type")));
    var __sv_6 = input["size"];
    if (typeof __sv_6 !== "number") _e.push(__zcIT("number", __sv_6, path.concat("size")));
    else if (Number.isNaN(__sv_6))
      _e.push({
        expected: "number",
        code: "invalid_type",
        received: "NaN",
    ...
    else if (!Number.isFinite(__sv_6))
      _e.push({
        expected: "number",
        code: "invalid_type",
        received: "Infinity",
  ...
  function safeParse_compiledProductSchema(input) {
    ...
    if (typeof _d !== "object" || _d === null || Array.isArray(_d))
      ...
      if (!Array.isArray(__sv_16)) _e.push(__zcIT("array", __sv_16, ["ratings"]));
        ...
        for (var __i_17 = 0; __i_17 < __sv_16.length; __i_17++)
          if (
            typeof __sv_16[__i_17] !== "object" ||
            __sv_16[__i_17] === null ||
            Array.isArray(__sv_16[__i_17])
          )
            _e.push(__zcIT("object", __sv_16[__i_17], ["ratings", __i_17]));
          else {
            var __sv_19 = __sv_16[__i_17]["id"];
            if (typeof __sv_19 !== "number")
              _e.push(__zcIT("number", __sv_19, ["ratings", __i_17, "id"]));
            else if (Number.isNaN(__sv_19))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "NaN",
                input: __sv_19,
                path: ["ratings", __i_17, "id"],
              });
            else if (!Number.isFinite(__sv_19))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "Infinity",
            ...
            if (typeof __sv_20 !== "number")
              _e.push(__zcIT("number", __sv_20, ["ratings", __i_17, "stars"]));
            else if (Number.isNaN(__sv_20))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "NaN",
                input: __sv_20,
                path: ["ratings", __i_17, "stars"],
              });
            else if (!Number.isFinite(__sv_20))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "Infinity",
              ...
              if (__sv_20 < 0)
                _e.push(__zcTS(0, "number", true, __sv_20, ["ratings", __i_17, "stars"]));
              if (__sv_20 > 5)
                _e.push(__zcTB(5, "number", true, __sv_20, ["ratings", __i_17, "stars"]));
            }
            var __sv_21 = __sv_16[__i_17]["title"];
            if (typeof __sv_21 !== "string") {
              _e.push(__zcIT("string", __sv_21, ["ratings", __i_17, "title"]));
              if (__sv_21 !== void 0 && __sv_21 !== null && __sv_21.length !== void 0) {
                if (__sv_21.length < 1)
                  _e.push(__zcTS(1, __zcLo(__sv_21), true, __sv_21, ["ratings", __i_17, "title"]));
                if (__sv_21.length > 100)
                  _e.push(
                    __zcTB(100, __zcLo(__sv_21), true, __sv_21, ["ratings", __i_17, "title"]),
                  );
              }
            } else {
              if (__sv_21.length < 1)
                _e.push(__zcTS(1, "string", true, __sv_21, ["ratings", __i_17, "title"]));
              if (__sv_21.length > 100)
                _e.push(__zcTB(100, "string", true, __sv_21, ["ratings", __i_17, "title"]));
            }
            var __sv_22 = __sv_16[__i_17]["text"];
            if (typeof __sv_22 !== "string") {
              _e.push(__zcIT("string", __sv_22, ["ratings", __i_17, "text"]));
              if (__sv_22 !== void 0 && __sv_22 !== null && __sv_22.length !== void 0) {
                if (__sv_22.length < 1)
                  _e.push(__zcTS(1, __zcLo(__sv_22), true, __sv_22, ["ratings", __i_17, "text"]));
                if (__sv_22.length > 1e3)
                  _e.push(__zcTB(1e3, __zcLo(__sv_22), true, __sv_22, ["ratings", __i_17, "text"]));
              }
            } else {
              if (__sv_22.length < 1)
                _e.push(__zcTS(1, "string", true, __sv_22, ["ratings", __i_17, "text"]));
              if (__sv_22.length > 1e3)
                _e.push(__zcTB(1e3, "string", true, __sv_22, ["ratings", __i_17, "text"]));
            }
            var __sv_23 = __sv_16[__i_17]["images"];
            __sv_23 = __zcSw_0(__sv_23, ["ratings", __i_17, "images"], _e);
            __sv_16[__i_17] = {
              id: __sv_19,
              stars: __sv_20,
              title: __sv_21,
