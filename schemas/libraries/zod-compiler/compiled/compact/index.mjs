...
function __zcMkv(fn, schema, fc, is) {
  var w = schema || {};
  var zpa = w.parseAsync,
    zspa = w.safeParseAsync;
  w.parse = fc
    ? function (input) {
...
const imageSchema = /* @__PURE__ */ z.object({
  id: z.number(),
  created: z.date(),
...
const ratingSchema = /* @__PURE__ */ z.object({
  id: z.number(),
...
const productSchema = /* @__PURE__ */ z.object({
  id: z.number(),
  created: z.date(),
  title: z.string().min(1).max(100),
...
const compiledProductSchema = /* @__PURE__ */ (() => {
  function safeParse_compiledProductSchema(input) {
    var _e = [];
    var _d = input;
    if (typeof _d !== "object" || _d === null || Array.isArray(_d))
      _e.push(__zcIT("object", _d, []));
    else {
      var __sv_5 = _d["id"];
      if (typeof __sv_5 !== "number") _e.push(__zcIT("number", __sv_5, ["id"]));
      else if (Number.isNaN(__sv_5))
        _e.push({
          expected: "number",
          code: "invalid_type",
          received: "NaN",
      ...
      else if (!Number.isFinite(__sv_5))
        _e.push({
          expected: "number",
          code: "invalid_type",
          received: "Infinity",
      ...
      if (typeof __sv_9 !== "string") {
        ...
        if (__sv_9 !== void 0 && __sv_9 !== null && __sv_9.length !== void 0) {
          ...
          if (__sv_9.length > 500)
            _e.push(__zcTB(500, __zcLo(__sv_9), true, __sv_9, ["description"]));
        }
      } else {
      ...
      else if (!Number.isFinite(__sv_10))
        _e.push({
          expected: "number",
          code: "invalid_type",
          received: "Infinity",
      ...
      if (__sv_11 !== null) {
        ...
        else if (!Number.isFinite(__sv_11))
          _e.push({
            expected: "number",
            code: "invalid_type",
            received: "Infinity",
      ...
      else if (!Number.isFinite(__sv_12))
        _e.push({
          expected: "number",
          code: "invalid_type",
          received: "Infinity",
      ...
      if (!Array.isArray(__sv_13)) _e.push(__zcIT("array", __sv_13, ["tags"]));
        ...
        for (var __i_14 = 0; __i_14 < __sv_13.length; __i_14++)
          if (typeof __sv_13[__i_14] !== "string") {
            _e.push(__zcIT("string", __sv_13[__i_14], ["tags", __i_14]));
            if (
              __sv_13[__i_14] !== void 0 &&
              __sv_13[__i_14] !== null &&
              __sv_13[__i_14].length !== void 0
            ) {
              if (__sv_13[__i_14].length < 1)
                _e.push(
                  __zcTS(1, __zcLo(__sv_13[__i_14]), true, __sv_13[__i_14], ["tags", __i_14]),
                );
              if (__sv_13[__i_14].length > 30)
                _e.push(
                  __zcTB(30, __zcLo(__sv_13[__i_14]), true, __sv_13[__i_14], ["tags", __i_14]),
                );
            }
          } else {
            if (__sv_13[__i_14].length < 1)
              _e.push(__zcTS(1, "string", true, __sv_13[__i_14], ["tags", __i_14]));
            if (__sv_13[__i_14].length > 30)
              _e.push(__zcTB(30, "string", true, __sv_13[__i_14], ["tags", __i_14]));
          }
      var __sv_15 = _d["images"];
      if (!Array.isArray(__sv_15)) _e.push(__zcIT("array", __sv_15, ["images"]));
      else {
        __sv_15 = __sv_15.slice();
        for (var __i_16 = 0; __i_16 < __sv_15.length; __i_16++)
          if (
            typeof __sv_15[__i_16] !== "object" ||
            __sv_15[__i_16] === null ||
            Array.isArray(__sv_15[__i_16])
          )
            _e.push(__zcIT("object", __sv_15[__i_16], ["images", __i_16]));
          else {
            var __sv_18 = __sv_15[__i_16]["id"];
            if (typeof __sv_18 !== "number")
              _e.push(__zcIT("number", __sv_18, ["images", __i_16, "id"]));
            else if (Number.isNaN(__sv_18))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "NaN",
                input: __sv_18,
                path: ["images", __i_16, "id"],
              });
            else if (!Number.isFinite(__sv_18))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "Infinity",
            ...
            if (!(__sv_19 instanceof Date))
              _e.push(__zcIT("date", __sv_19, ["images", __i_16, "created"]));
            else if (isNaN(__sv_19.getTime()))
              _e.push({
                expected: "date",
                code: "invalid_type",
                received: "Invalid Date",
                input: __sv_19,
                path: ["images", __i_16, "created"],
              });
            var __sv_20 = __sv_15[__i_16]["title"];
            if (typeof __sv_20 !== "string") {
              _e.push(__zcIT("string", __sv_20, ["images", __i_16, "title"]));
              if (__sv_20 !== void 0 && __sv_20 !== null && __sv_20.length !== void 0) {
                if (__sv_20.length < 1)
                  _e.push(__zcTS(1, __zcLo(__sv_20), true, __sv_20, ["images", __i_16, "title"]));
                if (__sv_20.length > 100)
                  _e.push(__zcTB(100, __zcLo(__sv_20), true, __sv_20, ["images", __i_16, "title"]));
              }
            } else {
              if (__sv_20.length < 1)
                _e.push(__zcTS(1, "string", true, __sv_20, ["images", __i_16, "title"]));
              if (__sv_20.length > 100)
                _e.push(__zcTB(100, "string", true, __sv_20, ["images", __i_16, "title"]));
            }
            var __sv_21 = __sv_15[__i_16]["type"];
            if (__sv_21 !== "jpg" && __sv_21 !== "png")
              _e.push(__zcIV(["jpg", "png"], __sv_21, ["images", __i_16, "type"]));
            var __sv_22 = __sv_15[__i_16]["size"];
            if (typeof __sv_22 !== "number")
              _e.push(__zcIT("number", __sv_22, ["images", __i_16, "size"]));
            else if (Number.isNaN(__sv_22))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "NaN",
                input: __sv_22,
                path: ["images", __i_16, "size"],
              });
            else if (!Number.isFinite(__sv_22))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "Infinity",
            ...
            if (typeof __sv_23 !== "string")
              _e.push(__zcIT("string", __sv_23, ["images", __i_16, "url"]));
            else {
              ...
              if (__u_25 === null)
                _e.push(__zcIF(void 0, "url", __sv_23, ["images", __i_16, "url"]));
      ...
      if (!Array.isArray(__sv_26)) _e.push(__zcIT("array", __sv_26, ["ratings"]));
        ...
        for (var __i_27 = 0; __i_27 < __sv_26.length; __i_27++)
          if (
            typeof __sv_26[__i_27] !== "object" ||
            __sv_26[__i_27] === null ||
            Array.isArray(__sv_26[__i_27])
          )
            _e.push(__zcIT("object", __sv_26[__i_27], ["ratings", __i_27]));
          else {
            var __sv_29 = __sv_26[__i_27]["id"];
            if (typeof __sv_29 !== "number")
              _e.push(__zcIT("number", __sv_29, ["ratings", __i_27, "id"]));
            else if (Number.isNaN(__sv_29))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "NaN",
                input: __sv_29,
                path: ["ratings", __i_27, "id"],
              });
            else if (!Number.isFinite(__sv_29))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "Infinity",
            ...
            if (typeof __sv_30 !== "number")
              _e.push(__zcIT("number", __sv_30, ["ratings", __i_27, "stars"]));
            else if (Number.isNaN(__sv_30))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "NaN",
                input: __sv_30,
                path: ["ratings", __i_27, "stars"],
              });
            else if (!Number.isFinite(__sv_30))
              _e.push({
                expected: "number",
                code: "invalid_type",
                received: "Infinity",
              ...
              if (__sv_30 < 0)
                _e.push(__zcTS(0, "number", true, __sv_30, ["ratings", __i_27, "stars"]));
              if (__sv_30 > 5)
                _e.push(__zcTB(5, "number", true, __sv_30, ["ratings", __i_27, "stars"]));
            }
            var __sv_31 = __sv_26[__i_27]["title"];
            if (typeof __sv_31 !== "string") {
              _e.push(__zcIT("string", __sv_31, ["ratings", __i_27, "title"]));
              if (__sv_31 !== void 0 && __sv_31 !== null && __sv_31.length !== void 0) {
                if (__sv_31.length < 1)
                  _e.push(__zcTS(1, __zcLo(__sv_31), true, __sv_31, ["ratings", __i_27, "title"]));
                if (__sv_31.length > 100)
                  _e.push(
                    __zcTB(100, __zcLo(__sv_31), true, __sv_31, ["ratings", __i_27, "title"]),
                  );
              }
            } else {
              if (__sv_31.length < 1)
                _e.push(__zcTS(1, "string", true, __sv_31, ["ratings", __i_27, "title"]));
              if (__sv_31.length > 100)
                _e.push(__zcTB(100, "string", true, __sv_31, ["ratings", __i_27, "title"]));
            }
            var __sv_32 = __sv_26[__i_27]["text"];
            if (typeof __sv_32 !== "string") {
              _e.push(__zcIT("string", __sv_32, ["ratings", __i_27, "text"]));
              if (__sv_32 !== void 0 && __sv_32 !== null && __sv_32.length !== void 0) {
                if (__sv_32.length < 1)
                  _e.push(__zcTS(1, __zcLo(__sv_32), true, __sv_32, ["ratings", __i_27, "text"]));
                if (__sv_32.length > 1e3)
                  _e.push(__zcTB(1e3, __zcLo(__sv_32), true, __sv_32, ["ratings", __i_27, "text"]));
              }
            } else {
              if (__sv_32.length < 1)
                _e.push(__zcTS(1, "string", true, __sv_32, ["ratings", __i_27, "text"]));
              if (__sv_32.length > 1e3)
                _e.push(__zcTB(1e3, "string", true, __sv_32, ["ratings", __i_27, "text"]));
            }
            var __sv_33 = __sv_26[__i_27]["images"];
            if (!Array.isArray(__sv_33))
              _e.push(__zcIT("array", __sv_33, ["ratings", __i_27, "images"]));
            else {
              __sv_33 = __sv_33.slice();
              for (var __i_34 = 0; __i_34 < __sv_33.length; __i_34++)
                if (
                  typeof __sv_33[__i_34] !== "object" ||
                  __sv_33[__i_34] === null ||
                  Array.isArray(__sv_33[__i_34])
                )
                  _e.push(__zcIT("object", __sv_33[__i_34], ["ratings", __i_27, "images", __i_34]));
                else {
                  var __sv_36 = __sv_33[__i_34]["id"];
                  if (typeof __sv_36 !== "number")
                    _e.push(__zcIT("number", __sv_36, ["ratings", __i_27, "images", __i_34, "id"]));
                  else if (Number.isNaN(__sv_36))
                    _e.push({
                      expected: "number",
                      code: "invalid_type",
                      received: "NaN",
                      input: __sv_36,
                      path: ["ratings", __i_27, "images", __i_34, "id"],
                    });
                  else if (!Number.isFinite(__sv_36))
                    _e.push({
                      expected: "number",
                      code: "invalid_type",
                      received: "Infinity",
                  ...
                  if (!(__sv_37 instanceof Date))
                    _e.push(
                      __zcIT("date", __sv_37, ["ratings", __i_27, "images", __i_34, "created"]),
                    );
                  else if (isNaN(__sv_37.getTime()))
                    _e.push({
                      expected: "date",
                      code: "invalid_type",
                      received: "Invalid Date",
                      input: __sv_37,
                      path: ["ratings", __i_27, "images", __i_34, "created"],
                    });
                  var __sv_38 = __sv_33[__i_34]["title"];
                  if (typeof __sv_38 !== "string") {
                    _e.push(
                      __zcIT("string", __sv_38, ["ratings", __i_27, "images", __i_34, "title"]),
                    );
                    if (__sv_38 !== void 0 && __sv_38 !== null && __sv_38.length !== void 0) {
                      if (__sv_38.length < 1)
                        _e.push(
                          __zcTS(1, __zcLo(__sv_38), true, __sv_38, [
                            "ratings",
                            __i_27,
                            "images",
                            __i_34,
                      ...
                      if (__sv_38.length > 100)
                        _e.push(
                          __zcTB(100, __zcLo(__sv_38), true, __sv_38, [
                            "ratings",
                            __i_27,
                            "images",
                            __i_34,
                    ...
                    if (__sv_38.length > 100)
                      _e.push(
                        __zcTB(100, "string", true, __sv_38, [
                          "ratings",
                          __i_27,
                          "images",
                          __i_34,
                  ...
                  if (__sv_39 !== "jpg" && __sv_39 !== "png")
                    _e.push(
                      __zcIV(["jpg", "png"], __sv_39, [
                        "ratings",
                        __i_27,
                        "images",
                        __i_34,
                  ...
                  if (typeof __sv_40 !== "number")
                    _e.push(
                      __zcIT("number", __sv_40, ["ratings", __i_27, "images", __i_34, "size"]),
                    );
                  else if (Number.isNaN(__sv_40))
                    _e.push({
                      expected: "number",
                      code: "invalid_type",
                      received: "NaN",
                      input: __sv_40,
                      path: ["ratings", __i_27, "images", __i_34, "size"],
                    });
                  else if (!Number.isFinite(__sv_40))
                    _e.push({
                      expected: "number",
                      code: "invalid_type",
                      received: "Infinity",
                  ...
                  if (typeof __sv_41 !== "string")
                    _e.push(
                      __zcIT("string", __sv_41, ["ratings", __i_27, "images", __i_34, "url"]),
                    );
                  else {
