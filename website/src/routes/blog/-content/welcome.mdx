...
After a closer review, we noticed a discrepancy between our example file for `zod` and its [docs](https://zod.dev), namely that our benchmark was using a _default_ export, and the docs show a _namespace_ export.
