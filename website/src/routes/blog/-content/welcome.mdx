...
We'd also like to thank `typebox`'s creator, [`@sinclairzx81`](https://github.com/sinclairzx81), for his assistance [correcting our benchmark](https://github.com/open-circle/schema-benchmarks/issues/55)!
