...
On the opposite end, [`zod`](https://zod.dev)'s "classic" API clocks in with the largest size of 58KB, with [`joi`](https://joi.dev) not far behind at 53KB, and [`effect/Schema`](https://effect.website/docs/schema/introduction/) at 50KB (though notably, [`effect`'s beta](https://effect.website/blog/releases/effect/40-beta/) has managed to reduce this significantly, to 19KB).
