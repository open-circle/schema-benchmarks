...
import { unsafeFromEntries, type MaybePromise } from "@schema-benchmarks/utils";
...
export async function* getTestCases(target: Target) {
...
export async function getAllTargetsCompliance(
  complianceFn: ComplianceFn,
): Promise<Record<Target, ComplianceResult>> {
